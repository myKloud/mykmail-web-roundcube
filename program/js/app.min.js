...
function rcube_webmail() {
  ...
  $.ajaxSetup({
    ...
    (this.set_env = function (e, t) {
      if (null == e || "object" != typeof e || t) this.env[e] = t;
      else for (var s in e) this.env[s] = e[s];
    }),
    (this.add_label = function (e, t) {
      "string" == typeof e
        ? (this.labels[e] = t)
        : "object" == typeof e && $.extend(this.labels, e);
    }),
          ...
          $("#" + t)
            ...
            .each(function () {
              var e = $(this),
                t = e.attr("onclick"),
                t =
                  t && String(t).match(/rcmail\.command\(\'([^']+)/)
                    ? RegExp.$1
                    : function () {
                        return e.is(".active");
                      };
        ...
        (this.menu_buttons_timeout = setTimeout(function () {
          $.each(ref.menu_buttons, function () {
            ...
            $.each(this[1], function () {
              ...
              if ((e && this()) || (!e && ref.commands[this])) return (t = !1);
            }),
              $(this[0])
                .add($(this[0]).parent(".dropbutton"))
                .addClass(t ? "disabled" : "active")
                .removeClass(t ? "active" : "disabled");
          });
        }, 50));
    }),
    ...
    (this.add_element = function (e, t) {
      this.gui_containers[t] &&
        this.gui_containers[t].jquery &&
        this.gui_containers[t].append(e);
    }),
    (this.register_command = function (e, t, s) {
      (this.command_handlers[e] = t), s && this.enable_command(e, !0);
    }),
    ...
    (this.init = function () {
      ...
      this.env.blankpage || (this.env.blankpage = "about:blank"),
      this.gui_containers))
      ...
      switch (
        ...
        case "mail":
          this.enable_command(
            ...
            this.gui_objects.messagelist &&
              ...
              (this.message_list = new rcube_list_widget(
                this.gui_objects.messagelist,
                {
                  multiselect: !0,
                  multiexpand: !0,
              ...
              this.message_list
                .addEventListener("initrow", function (e) {
            ...
            "show" == this.env.action || "preview" == this.env.action
              ? (this.enable_command(this.env.message_commands, this.env.uid),
                this.enable_command("reply-list", this.env.list_post),
                "show" == this.env.action &&
                  this.http_request(
                    "pagenav",
                    {
                      _uid: this.env.uid,
                ...
                this.env.blockedobjects &&
                  ($(this.gui_objects.remoteobjectsmsg).show(),
                  this.enable_command("load-remote", !0)),
                "preview" == this.env.action &&
                  this.is_framed() &&
                  (this.enable_command("compose", "add-contact", !1),
                  parent.rcmail.show_contentframe(!0)),
                0 <= $.inArray("flagged", this.env.message_flags) &&
                  $(document.body).addClass("status-flagged"),
                this.gui_objects.attachments &&
                  $("li > a", this.gui_objects.attachments)
                    .not(".drop")
                    .on("dragstart", function (e) {
                      var t = this.href,
                        s = e.originalEvent.dataTransfer;
                      s &&
                        ((t = t.replace(/^https?:\/\//, function (e) {
              ...
              ? ((this.env.address_group_stack = []),
                ...
                $.merge(this.env.compose_commands, [
                  "add-recipient",
                  "firstpage",
                  "previouspage",
                  "nextpage",
                ...
                this.gui_objects.responseslist &&
                  ...
                  $.each(this.buttons["save-response"] || [], function (e, t) {
                    $("#" + t.id).mousedown(function (e) {
                      return rcube_event.cancel(e);
                    });
                  })),
                this.init_messageform(),
                this.check_mailvelope(this.env.action))
              : "bounce" == this.env.action
              ? (this.init_messageform_inputs(),
                (this.env.compose_commands = []))
              : "get" == this.env.action
              ? (this.enable_command("download", !0),
                this.enable_command(
                  "image-scale",
                  "image-rotate",
                  !!/^image\//.test(this.env.mimetype)
                ),
                this.enable_command(
                  "print",
                  "application/pdf" != this.env.mimetype ||
                    !bw.mz ||
                    75 <= bw.vendver
                ),
                this.env.is_message &&
                  ...
                  $(this.gui_objects.messagepartframe).on("load", function () {
                    ...
                    e.find("img").length &&
                      e
                        .find("head")
                        .append(
                          '<style type="text/css">img { max-width:100%; max-height:100%; } body { display:flex; align-items:center; justify-content:center; height:100%; margin:0; }</style>'
                        );
                  }))
              : "print" == this.env.action &&
                this.env.uid &&
                (this.check_mailvelope(this.env.action),
                this.env.is_pgp_content ||
                  this.env.pgp_mime_part ||
                  this.print_dialog()),
            this.gui_objects.mailboxlist &&
              ((this.env.unread_counts = {}),
              (this.gui_objects.folderlist = this.gui_objects.mailboxlist),
              this.http_request("getunread", { _page: this.env.current_page })),
            this.gui_objects.contactslist &&
              ((this.contact_list = new rcube_list_widget(
                this.gui_objects.contactslist,
                { multiselect: !0, draggable: !1, keyboard: !0 }
              )),
              this.contact_list
                .addEventListener("initrow", function (e) {
                  ref.triggerEvent("insertrow", { cid: e.uid, row: e });
                })
                .addEventListener("select", function (e) {
                ...
                .addEventListener("keypress", function (e) {
                  e.key_pressed == e.ENTER_KEY &&
                    (ref.compose_add_recipient() ||
                      (e.last_selected &&
                        "G" == String(e.last_selected).charAt(0) &&
                        $(e.rows[e.last_selected].obj)
                          .find("a")
                          .first()
                          .click()));
                })
        ...
        case "addressbook":
          (this.env.address_group_stack = []),
            this.gui_objects.folderlist &&
              (this.env.contactfolders = $.extend(
                $.extend({}, this.env.address_sources),
            ...
            this.gui_objects.contactslist &&
              ...
              this.command("list")),
            this.gui_objects.savedsearchlist &&
              ((this.savedsearchlist = new rcube_treelist_widget(
                this.gui_objects.savedsearchlist,
                {
                  id_prefix: "rcmli",
            ...
            this.env.cid &&
              (this.enable_command("show", "edit", "qrcode", !0),
              this.gui_objects.editform &&
                $("input.groupmember").change(function () {
                  ref.group_member_change(
                    this.checked ? "add" : "del",
                    ref.env.cid,
                    ref.env.source,
                    this.value
                  );
            ...
            this.gui_objects.editform
              ? (this.enable_command("save", !0),
                ("add" != this.env.action &&
                  "edit" != this.env.action &&
                  "search" != this.env.action) ||
                  this.init_contact_form())
              : "print" == this.env.action && this.print_dialog();
          break;
        case "settings":
          this.enable_command("show", "save", !0),
            "identities" == this.env.action
              ? this.enable_command("add", this.env.identities_level < 2)
              : "edit-identity" == this.env.action ||
                "add-identity" == this.env.action
              ? (this.enable_command("save", "edit", "toggle-editor", !0),
                this.enable_command("delete", this.env.identities_level < 2),
                this.editor_init(this.env.editor_config, "rcmfd_signature"),
                "edit-identity" == this.env.action &&
                  this.check_mailvelope(this.env.action))
              : "folders" == this.env.action
              ? this.enable_command(
                  "subscribe",
                  "unsubscribe",
                  "create-folder",
              ...
              : "edit-folder" == this.env.action && this.gui_objects.editform
              ? (this.enable_command("save", "folder-size", !0),
                (parent.rcmail.env.exists = this.env.messagecount),
                parent.rcmail.enable_command("purge", this.env.messagecount))
              : "responses" == this.env.action &&
                this.enable_command("add", !0),
            this.gui_objects.identitieslist
              ? ((this.identity_list = new rcube_list_widget(
                  this.gui_objects.identitieslist,
                  { multiselect: !1, draggable: !1, keyboard: !0 }
                )),
                this.identity_list
                  .addEventListener("select", function (e) {
                  ...
                  .init()
                  .focus())
              : this.gui_objects.sectionslist
              ? ((this.sections_list = new rcube_list_widget(
                  this.gui_objects.sectionslist,
                  { multiselect: !1, draggable: !1, keyboard: !0 }
                )),
                this.sections_list
                  ...
                  .init()
                  .focus())
              : this.gui_objects.subscriptionlist
              ? this.init_subscription_list()
              : this.gui_objects.responseslist &&
                ((this.responses_list = new rcube_list_widget(
                  this.gui_objects.responseslist,
                  { multiselect: !1, draggable: !1, keyboard: !0 }
                )),
                this.responses_list
      ...
      this.gui_objects.editform &&
        ...
        this.gui_objects.folderlist &&
          ...
          ((this.treelist = new rcube_treelist_widget(
            this.gui_objects.folderlist,
            {
              selectable: !0,
              id_prefix: "rcmli",
      ...
      this.onloads))
        "string" == typeof this.onloads[n]
          ? eval(this.onloads[n])
          : "function" == typeof this.onloads[n] && this.onloads[n]();
    ...
    (this.command = function (e, t, s, i, n) {
      if (
        (!s || !s.blur || (i && rcube_event.is_keyboard(i)) || s.blur(),
        this.busy &&
          ("reset-search" != e || "search" != this.last_command) &&
          !e.match(/^menu-/))
      )
        return !1;
      if (
        s &&
        s.href &&
        String(s.href).indexOf("#") < 0 &&
        rcube_event.get_modifier(i)
      )
        return !0;
      if (!n && !this.commands[e])
        return this.is_framed() && parent.rcmail.command(e, t), !1;
      if (
        "mail" == this.task &&
        "compose" == this.env.action &&
        !this.env.server_error &&
        "save-pref" != e &&
        ($.inArray(e, this.env.compose_commands) < 0 ||
          (e.startsWith("compose-encrypted") && ref.mailvelope_editor)) &&
      ...
      return (
        (n =
          "function" == typeof this.command_handlers[e]
            ? this.command_handlers[e](t, s, i)
            : "string" == typeof this.command_handlers[e]
            ? window[this.command_handlers[e]](t, s, i)
            : this.command_handler(e, t, s, i)),
        this.command_aborted ||
          !1 !== this.triggerEvent("after" + e, t) ||
          (n = !1),
    ...
    (this.command_handler = function (e, t, s, i) {
      ...
      switch (e) {
        ...
        case "about":
          ...
          break;
        case "permaurl":
          if (s && s.href && s.target) return !0;
          this.env.permaurl && (parent.location.href = this.env.permaurl);
          break;
        case "extwin":
          "compose" == this.env.action
            ? ((m = this.gui_objects.messageform),
              (l = this.open_window("")) &&
                ...
                (m.target = l.name),
                m.submit()))
            : this.open_window(this.env.permaurl, !0);
          break;
        case "change-format":
          (a = this.env.permaurl + "&_format=" + t),
            "preview" == this.env.action &&
              (a = a.replace(/_action=show/, "_action=preview") + "&_framed=1"),
            this.env.extwin && (a += "&_extwin=1"),
            (location.href = a);
          break;
        case "menu-open":
          t &&
            "attachmentmenu" == t.menu &&
            ((c = this.env.attachments[t.id]) && c.mimetype && (c = c.mimetype),
            this.enable_command(
              "open-attachment",
              c && this.env.mimetypes && 0 <= $.inArray(c, this.env.mimetypes)
            )),
        ...
        case "menu-close":
          ...
          break;
        case "menu-save":
          return this.triggerEvent(e, { props: t, originalEvent: i }), !1;
        case "open":
          if ((u = this.get_single_uid()))
            return (
              (s.href = this.url(
                "show",
                this.params_from_uid(u, { _extwin: 1 })
              )),
              !0
            );
          break;
        ...
        case "list":
          t && "" != t && this.reset_qsearch(!0),
            "compose" == this.env.action && this.env.extwin
              ? window.close()
              : "mail" == this.task
              ? (this.list_mailbox(t, t ? 1 : ""), this.set_button_titles())
              : "addressbook" == this.task && this.list_contacts(t);
          break;
        case "set-listmode":
        ...
        case "sort":
          ...
          this.env.disabled_sort_order ||
            (o = this.env.sort_col == l && "ASC" == o ? "DESC" : "ASC"),
        ...
        case "show":
          "mail" == this.task
            ? !(u = this.get_single_uid()) ||
              (this.env.uid && u == this.env.uid) ||
              ((o = this.get_message_mailbox(u)) == this.env.drafts_mailbox
                ? this.open_compose_step({ _draft_uid: u, _mbox: o })
                : this.show_message(u))
            : "addressbook" == this.task
            ? !(n = t || this.get_single_cid()) ||
              ("show" == this.env.action && n == this.env.cid) ||
              this.load_contact(n, "show")
            : "settings" == this.task &&
              this.goto_url("settings/" + t, { _framed: 0 });
          break;
        case "add":
          "addressbook" == this.task
            ? this.load_contact(0, "add")
            : "settings" == this.task && "responses" == this.env.action
            ? this.load_response(0, "add-response")
            : "settings" == this.task && this.load_identity(0, "add-identity");
          break;
        case "edit":
          "addressbook" == this.task && (n = this.get_single_cid())
            ? this.load_contact(n, "edit")
            : "mail" == this.task &&
              (u = this.get_single_uid()) &&
              (((a = { _mbox: this.get_message_mailbox(u) })[
                a._mbox == this.env.drafts_mailbox && "new" != t
                  ? "_draft_uid"
                  : "_uid"
              ] = u),
        ...
        case "save":
          if ((m = this.gui_objects.editform)) {
            if (
              (r = $("[name='_pagesize']", m)) &&
              r.length &&
              isNaN(parseInt(r.val()))
            ) {
              this.alert_dialog(
                this.get_label("nopagesizewarning"),
                function () {
                  r.focus();
                }
              );
            ...
            if ("reload" == t) m.action += "&_reload=1";
            else if (
              "settings" == this.task &&
              this.env.identities_level % 2 == 0 &&
              (r = $("[name='_email']", m)) &&
              r.length &&
              !rcube_check_email(r.val())
            ) {
        ...
        case "delete":
          "mail" == this.task
            ? this.delete_messages(i)
            : "addressbook" == this.task
            ? this.delete_contacts()
            : "settings" == this.task && "responses" == this.env.action
            ? this.delete_response()
            : "settings" == this.task && this.delete_identity();
          break;
        case "move":
        case "moveto":
          "mail" == this.task
            ? this.move_messages(t, i)
            : "addressbook" == this.task && this.move_contacts(t, i);
          break;
        case "copy":
          "mail" == this.task
            ? this.copy_messages(t, i)
            : "addressbook" == this.task && this.copy_contacts(t, i);
          break;
        case "mark":
        ...
        case "toggle_status":
        case "toggle_flag":
          (v = "toggle_flag" == e ? "flagged" : "read"),
            (u = t) &&
              ("flagged" == v
                ? this.message_list.rows[u].flagged && (v = "unflagged")
                : this.message_list.rows[u].deleted
                ? (v = "undelete")
                : this.message_list.rows[u].unread || (v = "unread"),
              this.mark_message(v, u));
          break;
        case "add-contact":
          this.add_contact(t);
          break;
        case "load-remote":
          if (this.env.uid) {
            if (t && this.env.sender) {
              this.add_contact(this.env.sender, !0);
              break;
            }
        ...
        case "download-attachment":
          ...
          if (
            ("compose" == this.env.action
              ? ((h = { _file: t, _id: this.env.compose_id }),
                (c = c ? c.mimetype : ""))
              : (h = { _mbox: this.env.mailbox, _uid: this.env.uid, _part: t }),
            "download-attachment" != e &&
              c &&
              this.env.mimetypes &&
              0 <= $.inArray(c, this.env.mimetypes) &&
              this.open_window(
                this.url("get", $.extend({ _frame: 1, _framed: 0 }, h))
              ))
          )
            break;
          (h._download = 1),
          ...
          break;
        case "select-all":
          (this.select_all_mode = !t), (this.dummy_select = !0);
          var h =
            this["addressbook" == this.task ? "contact_list" : "message_list"];
          "invert" == t
            ? h.invert_selection()
            : h.select_all("page" == t ? "" : t),
            (this.dummy_select = null);
          break;
        case "select-none":
          (this.select_all_mode = !1),
            this[
              "addressbook" == this.task ? "contact_list" : "message_list"
            ].clear_selection();
          break;
        case "expand-all":
          (this.env.autoexpand_threads = 1), this.message_list.expand_all();
          break;
        case "expand-unread":
          ...
          break;
        case "collapse-all":
          (this.env.autoexpand_threads = 0), this.message_list.collapse_all();
          break;
        case "nextmessage":
          this.env.next_uid &&
            this.show_message(
        ...
        case "compose":
          if (((a = {}), "mail" == this.task))
            (a = { _mbox: this.env.mailbox, _search: this.env.search_request }),
              t && (a._to = t);
          else if ("addressbook" == this.task)
            if (t && 0 < t.indexOf("@")) a._to = t;
            else {
              var d = [];
              if (
                (t
                  ? d.push(t)
                  : this.contact_list &&
                    (d = this.contact_list.get_selection()),
                d.length)
              ) {
                this.http_post(
                  "mailto",
                  { _cid: d.join(","), _source: this.env.source },
                  !0
                );
                break;
              }
              if (this.env.group && this.env.pagecount) {
                this.http_post(
                  "mailto",
                  { _gid: this.env.group, _source: this.env.source },
                  !0
                );
                break;
              }
        ...
        case "send":
          if (!t.nocheck && !this.env.is_sent && !this.check_compose_input(e))
            break;
          clearTimeout(this.save_timer), this.submit_messageform();
          break;
        case "send-attachment":
          clearTimeout(this.save_timer),
            (v = this.upload_file(
              t || this.gui_objects.uploadform,
              "upload"
            )) ||
              (!1 !== v &&
        ...
        case "insert-sig":
          ...
          break;
        case "list-addresses":
          this.list_contacts(t), this.enable_command("add-recipient", !1);
          break;
        case "add-recipient":
        ...
        case "reply":
          (u = this.get_single_uid()) &&
            ((a = {
              _reply_uid: u,
              _mbox: this.get_message_mailbox(u),
              _search: this.env.search_request,
            }),
            "reply-all" == e
              ? (a._all =
                  !t &&
                  1 == this.env.reply_all_mode &&
                  this.commands["reply-list"]
                    ? "list"
                    : "all")
              : "reply-list" == e && (a._all = "list"),
            this.open_compose_step(a));
          break;
        ...
        case "forward":
          d = this.env.uid
            ? [this.env.uid]
            : this.message_list
            ? this.message_list.get_selection()
            : [];
          d.length &&
            ((a = {
            ...
            ("forward-attachment" == e ||
              (!t && this.env.forward_attachment) ||
              1 < d.length) &&
              (a._attachment = 1),
            this.open_compose_step(a));
          break;
        case "print":
          "addressbook" == this.task
            ? (u = this.get_single_cid()) &&
              ((a = "&_action=print&_cid=" + u),
              this.env.source &&
                (a += "&_source=" + urlencode(this.env.source)),
              this.open_window(this.env.comm_path + a, !0, !0))
            : "get" != this.env.action || this.env.is_message
            ? (u = this.get_single_uid()) &&
              ((a = this.url(
                "print",
                this.params_from_uid(u, { _safe: this.env.safemode ? 1 : 0 })
              )),
              this.open_window(a, !0, !0) &&
                "show" != this.env.action &&
                "get" != this.env.action &&
                this.mark_message("read", u))
            : this.gui_objects.messagepartframe.contentWindow.print();
          break;
        case "viewsource":
          (u = this.get_single_uid()) &&
            this.open_window(
              this.url("viewsource", this.params_from_uid(u)),
              !0,
              !0
            );
          break;
        case "download":
          "get" == this.env.action
            ? (location.href = this.secure_url(
                location.href.replace(/_frame=/, "_download=")
              ))
            : (u = this.get_single_uid()) &&
              this.goto_url(
                "viewsource",
                this.params_from_uid(u, { _save: 1 }),
                !1,
                !0
              );
          break;
        ...
        case "reset-search":
          var _,
            u = this.env.search_request || this.env.qsearch;
          if ((this.reset_qsearch(!0), u && "compose" == this.env.action))
            this.contact_list && this.list_contacts_clear();
          else if (u && this.env.mailbox)
            this.list_mailbox(this.env.mailbox, 1);
          else if (u && "addressbook" == this.task) {
            if ("" == this.env.source) {
              for (_ in this.env.address_sources) break;
              (this.env.source = _), (this.env.group = "");
            }
        ...
        case "pushgroup":
          var p = {
            ...
            search:
              this.env.search_request && this.gui_objects.qsearchbox
                ? this.gui_objects.qsearchbox.value
                : null,
          };
          this.env.address_group_stack.push(p), s && i && rcube_event.cancel(i);
        case "listgroup":
          this.reset_qsearch(), this.list_contacts(t.source, t.id, 1, p);
          break;
        case "popgroup":
          this.env.address_group_stack.length &&
            ((f = this.env.address_group_stack.pop()),
            this.reset_qsearch(),
            f.search_request
              ? (f.search &&
                  this.gui_objects.qsearchbox &&
                  $(this.gui_objects.qsearchbox).val(f.search),
                (this.env.search_request = f.search_request),
                this.list_contacts_remote(
                  null,
                  null,
                  (this.env.current_page = f.page)
                ))
              : this.list_contacts(
                  t.source,
                  this.env.address_group_stack[
                    this.env.address_group_stack.length - 1
                  ].id
                ));
          break;
        case "import-messages":
          ...
          (v = this.upload_file(m, "import", f)) ||
            (this.set_busy(!1, null, f),
            !1 !== v && this.alert_dialog(this.get_label("selectimportfile")),
            (this.command_aborted = !0));
          break;
        case "import":
          var g = $("<iframe>").attr(
            "src",
            this.url("import", { _framed: 1, _target: this.env.source })
          );
          (this.import_state = null),
            (this.import_dialog = this.simple_dialog(
              g,
              this.gettext("importcontacts"),
              function (e) {
                var t,
                  s = g[0].contentWindow,
                  i = null;
                (i =
                  s.rcmail.gui_objects.importformmap ||
                  s.rcmail.gui_objects.importform) &&
                  (!(t = s.$("#rcmimportfile")[0]) || t.value
                    ? ((t = s.rcmail.set_busy(!0, "importwait")),
                      $('[name="_unlock"]', i).val(t),
                      i.submit(),
                      s.rcmail.lock_form(i, !0),
                      $(e.target).attr("disabled", !0).next().focus())
                    : s.rcmail.alert_dialog(
                        s.rcmail.get_label("selectimportfile")
                      ));
              },
              {
                close: function (e, t) {
        ...
        default:
          var v = e.replace(/-/g, "_");
          if (this[v] && "function" == typeof this[v]) return this[v](t, s, i);
      }
    }),
    (this.enable_command = function () {
      for (
        var e, t, s = Array.prototype.slice.call(arguments), i = s.pop(), n = 0;
        n < s.length;
        n++
      )
        if ("string" == typeof (t = s[n]))
          (this.commands[t] = i),
            ...
            this.triggerEvent("enable-command", { command: t, status: i });
        else for (e in t) s.push(t[e]);
      this.set_menu_buttons();
    }),
    ...
    (this.set_busy = function (e, t, s) {
      ...
      return (
        e && t
          ? ((i = this.get_label(t)),
            (s = this.display_message(
              (i = i == t ? "Loading..." : i),
              "loading"
            )))
          : !e && s && this.hide_message(s),
        (this.busy = e),
        this.gui_objects.editform &&
          this.lock_form(this.gui_objects.editform, e),
        s
      );
    }),
    (this.get_label = function (e, t) {
      return t && this.labels[t + "." + e]
        ? this.labels[t + "." + e]
        : this.labels[e] || e;
    }),
    ...
    (this.switch_task = function (e) {
      var t, s;
      2 == (s = e.split("/")).length && ((e = s[0]), (t = s[1])),
        (this.task === e && "mail" != e) ||
          ((s = this.get_task_url(e)),
          t && (s += "&_action=" + t),
          "mail" == e
            ? (s += "&_mbox=INBOX")
            : "logout" == e &&
              ((s = this.secure_url(s)), this.clear_compose_data()),
          this.redirect(s));
    }),
    (this.get_task_url = function (e, t) {
      return (t = t || this.env.comm_path).match(/[?&]_task=[a-zA-Z0-9_-]+/)
        ? t.replace(/_task=[a-zA-Z0-9_-]+/, "_task=" + e)
        : t.replace(/\?.*$/, "") + "?_task=" + e;
    }),
    (this.reload = function (e) {
      this.is_framed()
        ? parent.rcmail.reload(e)
        : e
        ? setTimeout(function () {
            ref.reload();
          }, e)
    ...
    (this.add_url = function (e, t, s) {
      ...
      return (
        (s = urlencode(s)),
        /(#[a-z0-9_-]+)$/.test(e) &&
          ((a = RegExp.$1), (e = e.substr(0, e.length - a.length))),
        /(\?.*)$/.test(e)
          ? ((i = RegExp.$1),
            (n = RegExp("((\\?|&)" + RegExp.escape(t) + "=[^&]*)")).test(i)
              ? (i = i.replace(n, RegExp.$2 + t + "=" + s))
              : (i += "&" + t + "=" + s),
            e.replace(/(\?.*)$/, i) + a)
          : e + "?" + t + "=" + s + a
      );
    ...
    (this.is_framed = function () {
      return (
        ...
        parent.rcmail &&
        parent.rcmail != this &&
        "function" == typeof parent.rcmail.command
      );
    }),
    (this.save_pref = function (e) {
      var t = { _name: e.name, _value: e.value };
    ...
    (this.html_identifier = function (e, t) {
      return t
        ? this.html_identifier_encode(e)
        : String(e).replace(this.identifier_expr, "_");
    }),
    (this.html_identifier_encode = function (e) {
      return Base64.encode(String(e))
        .replace(/=+$/, "")
        .replace(/\+/g, "-")
        .replace(/\//g, "_");
    }),
    ...
    (this.drag_menu = function (e, t) {
      ...
      if (i && s == SHIFT_KEY && this.commands.copy) {
        ...
        return (
          (this.env.drag_target = t),
          this.show_menu(this.gui_objects.dragmenu.id, !0, e),
          $(i).css({ top: s.y - 10 + "px", left: s.x - 10 + "px" }),
          !0
        );
      }
      return !1;
    ...
    (this.drag_end = function (e) {
      ...
      this.treelist && this.treelist.drag_end(),
        (t = this.message_list)
          ? (s = this.env.mailboxes)
          : (t = this.contact_list) && (s = this.env.contactfolders),
        this.drag_active &&
          s &&
          this.env.last_folder_target &&
          !rcube_event.is_keyboard(e) &&
          ((s = s[this.env.last_folder_target]),
          t.draglayer.hide(),
          this.contact_list
            ? this.contacts_drag_menu(e, s) || this.command("move", s)
            : this.drag_menu(e, s) || this.command("move", s)),
        (this.drag_active = !1),
    ...
    (this.drag_move = function (e) {
      ...
      this.gui_objects.folderlist &&
        ...
        this.contact_list &&
          this.contact_list.draglayer &&
          (s = this.contact_list.draglayer.attr("class")),
        this.treelist && (t = this.treelist.intersects(e, !0))
          ? ((this.env.last_folder_target = t),
            (i =
              "draglayer" + (1 < this.check_droptarget(t) ? "copy" : "normal")))
          : (this.env.last_folder_target = null),
        i != s &&
          this.contact_list &&
          this.contact_list.draglayer &&
          this.contact_list.draglayer.attr("class", i));
    }),
    ...
    (this.folder_collapsed = function (e) {
      ...
      var t,
        s =
          "addressbook" == this.env.task
            ? "collapsed_abooks"
            : "collapsed_folders",
        i = this.env[s];
      e.collapsed
        ? ((this.env[s] = this.env[s] + "&" + urlencode(e.id) + "&"),
          !e.virtual &&
            this.env.mailbox &&
            this.env.mailbox.startsWith(e.id + this.env.delimiter) &&
            this.command("list", e.id))
        : ((t = new RegExp("&" + urlencode(e.id) + "&")),
          (this.env[s] = this.env[s].replace(t, ""))),
        this.drag_active ||
          (i !== this.env[s] &&
            (this.folder_collapsed_timer = setTimeout(function () {
              ref.command("save-pref", { name: s, value: ref.env[s] });
            }, 10)),
          this.env.unread_counts && this.set_unread_count_display(e.id, !1));
    }),
    (this.doc_mouse_up = function (s) {
      var e,
        r = rcube_event.get_target(s);
      if (!$(r).closest(".ui-dialog, .ui-widget-overlay").length) {
        if (
          (window.rcube_list_widget &&
            rcube_list_widget._instances.length &&
            $.each(rcube_list_widget._instances, function (e, t) {
        ...
        setTimeout(
          function (e) {
            for (
              var t, s, i, n = $(r).parents(), a = ref.menu_stack.length - 1;
              0 <= a;
              a--
            )
              (i = ref.menu_stack[a]),
                !(t = $("#" + i)).is(":visible") ||
                  ...
                  n.is(t.data("opener")) ||
                  i == s ||
                  ("true" == t.attr("data-editable") &&
                    $(r).parents("#" + i).length) ||
                  ("true" == t.attr("data-sticky") &&
                    rcube_mouse_is_over(e, t.get(0))) ||
                  ref.hide_menu(i, e),
                (s = t.data("parent"));
          },
          10,
    ...
    (this.doc_keypress = function (e) {
      function t(e) {
        var t,
          s = e < 0 ? "prevAll" : "nextAll",
          i = e < 0 ? "last" : "first";
        return ref.focused_menu && (t = $("#" + ref.focused_menu))
          ? (e = !(e = t
              .find(":focus")
              .closest("li")
              [s]()
      ...
      switch (i) {
        ...
        case 63232:
        case 63233:
          return t(38 == i || 63232 == i ? -1 : 1), rcube_event.cancel(e);
        case 9:
          return (
            this.focused_menu &&
              (t(rcube_event.get_modifier(e) == SHIFT_KEY ? -1 : 1) ||
                this.hide_menu(this.focused_menu, e)),
            rcube_event.cancel(e)
          );
        case 27:
          this.menu_stack.length &&
            this.hide_menu(this.menu_stack[this.menu_stack.length - 1], e);
      }
      return !0;
    }),
    (this.list_keypress = function (e, t) {
      e.modkey != CONTROL_KEY &&
        (e.key_pressed == e.DELETE_KEY || e.key_pressed == e.BACKSPACE_KEY
          ? this.command(t && t.del ? t.del : "delete")
          : 33 == e.key_pressed
          ? this.command(t && t.prev ? t.prev : "previouspage")
          : 34 == e.key_pressed &&
            this.command(t && t.next ? t.next : "nextpage"));
    }),
    (this.msglist_keypress = function (e) {
      e.key_pressed != e.ENTER_KEY || this.env.contentframe
        ? this.list_keypress(e)
        : this.command("show");
    }),
      ...
      this.enable_command(this.env.message_commands, null != t),
        ...
        t &&
          (s
            ...
            : this.env.messages[t].ml || this.enable_command("reply-list", !1)),
        ...
        t && this.env.contentframe && !e.multi_selecting && !this.dummy_select
          ? ((t =
              (n = new Date().getTime()) -
              (this._last_msglist_select_time || 0)),
            (e = this.preview_delay_click),
            t < this.preview_delay_select &&
              ((e = this.preview_delay_select),
              this.preview_timer && clearTimeout(this.preview_timer),
    ...
    (this.msglist_dbl_click = function (e) {
      ...
      t &&
        ((e = this.get_message_mailbox(t)) == this.env.drafts_mailbox
          ? this.open_compose_step({ _draft_uid: t, _mbox: e })
          : this.show_message(t));
    }),
    (this.msglist_get_preview = function () {
      var e = this.get_single_uid();
      e && this.env.contentframe && !this.drag_active
        ? this.show_message(e, !1, !0)
        : this.env.contentframe && this.show_contentframe(!1);
    }),
    (this.msglist_expand = function (e) {
      this.env.messages[e.uid] &&
        (this.env.messages[e.uid].expanded = e.expanded),
        $(e.obj)[e.expanded ? "addClass" : "removeClass"]("expanded");
    }),
    (this.msglist_set_coltypes = function (e) {
      var t,
        s,
        i = e.thead.rows[0].cells;
      for (this.env.listcols = [], t = 0; t < i.length; t++)
        i[t].id &&
          i[t].id.startsWith("rcm") &&
          ((s = i[t].id.slice(3)), this.env.listcols.push(s));
      this.msglist_setup(this.env.layout),
        0 <= (e = $.inArray("flag", this.env.listcols)) &&
          (this.env.flagged_col = e),
        0 <= (e = $.inArray("subject", this.env.listcols)) &&
          (this.env.subject_col = e),
    ...
    (this.check_droptarget = function (e) {
      switch (this.task) {
        case "mail":
          return !this.env.mailboxes[e] ||
            this.env.mailboxes[e].virtual ||
            (this.env.mailboxes[e].id == this.env.mailbox &&
              !this.is_multifolder_listing())
            ? 0
            : 1;
        case "addressbook":
          var t;
          if (e != this.env.source && (t = this.env.contactfolders[e]))
            if ("group" == t.type) {
              if (
                t.id != this.env.group &&
                !this.env.contactfolders[t.source].readonly
              )
                return !(
                  1 < this.env.selection_sources.length ||
                  -1 == $.inArray(t.source, this.env.selection_sources)
                ) || this.commands.move
                  ? 1
                  : 2;
            } else if (
              !t.readonly &&
              (1 < this.env.selection_sources.length ||
                -1 == $.inArray(e, this.env.selection_sources))
            )
    ...
    (this.open_window = function (e, t, s) {
      var i,
        ...
        a,
        r,
        o = "rcmextwin" + new Date().getTime();
      if (
        ((e += (e.match(/\?/) ? "&" : "?") + "_extwin=1"),
        (r = this.env.standard_windows
          ? window.open(e, o)
          : ((a = this.is_framed() ? parent.window : window),
            (n = (i = $(a)).width()),
            (i = (bw.mz ? $("body", a) : i).height()),
            (t = Math.min(
              t ? this.env.popup_width_small : this.env.popup_width,
              n
            )),
        ...
        return (
          !e &&
            r.document &&
            r.document.write(
              "<html><body>" + this.get_label("loading") + "</body></html>"
            ),
          this.triggerEvent("openwindow", { url: e, handle: r }),
          setTimeout(function () {
            r && r.focus();
          }, 10),
          r
    ...
    (this.init_message_row = function (s) {
      ...
      t && this.env.messages[t] && $.extend(s, this.env.messages[t]),
        (s.icon = document.getElementById(i)) &&
          (e.icon = function (e) {
            ref.command("toggle_status", t);
          }),
        null != this.env.status_col
          ? (s.msgicon = document.getElementById("msgicn" + s.id))
          : (s.msgicon = s.icon),
        null != this.env.flagged_col &&
          (s.flagicon = document.getElementById("flagicn" + s.id)) &&
          (e.flagicon = function (e) {
            ref.command("toggle_flag", t);
          }),
        !s.depth &&
          s.has_children &&
          (s.expando = document.getElementById("rcmexpando" + s.id)) &&
          (e.expando = function (e) {
            ref.expand_message_row(e, t);
          }),
        $.each(e, function (e, t) {
          (s[e].onclick = function (e) {
            return t(e), rcube_event.cancel(e);
          }),
            bw.touch &&
        ...
        this.triggerEvent("insertrow", { uid: t, row: s });
    }),
    (this.add_message_row = function (e, t, s, i) {
      if (!this.gui_objects.messagelist || !this.message_list) return !1;
      if (s.mbox != this.env.mailbox && !s.skip_mbox_check) return !1;
      if (this.message_list.rows[e]) return !1;
      ...
      var n,
        ...
        u = this.message_list,
        p = u.rows,
        m = this.env.messages[e],
        f = this.html_identifier(e, !0),
        g =
          "message" +
          (s.seen ? "" : " unread") +
          (s.deleted ? " deleted" : "") +
          (s.flagged ? " flagged" : "") +
          (m.selected ? " selected" : ""),
        v = { cols: [], style: {}, id: "rcmrow" + f, uid: e },
        b = this.env.msglist_layout,
        y = this.env.msglist_cols;
        // console.log(y) check omar
      for (n in ("widescreen" == b
        ? (this.env.status_col = null)
        : 0 <= (n = $.inArray("status", y)) && (this.env.status_col = n),
      (o = "msgicon"),
      null === this.env.status_col &&
        ((o += " status"),
        s.deleted
          ? ((c += " deleted"), (h += this.get_label("deleted") + " "))
          : s.seen
          ? 0 < s.unread_children && (c += " unreadchildren")
          : ((c += " unread"), (h += this.get_label("unread") + " "))),
      s.answered && ((c += " replied"), (h += this.get_label("replied") + " ")),
      s.forwarded &&
        ((c += " forwarded"), (h += this.get_label("forwarded") + " ")),
      m.selected && !u.in_selection(e) && u.selection.push(e),
      this.env.threading &&
        (m.depth
          ? ((d +=
              '<span id="rcmtab' +
              f +
              '" class="branch" style="width:' +
              15 * m.depth +
              'px;">&nbsp;&nbsp;</span>'),
            (p[m.parent_uid] && !1 === p[m.parent_uid].expanded) ||
            !(
              (0 != this.env.autoexpand_threads &&
                2 != this.env.autoexpand_threads) ||
              (p[m.parent_uid] && p[m.parent_uid].expanded)
            )
              ? ((v.style.display = "none"), (m.expanded = !1))
              : (m.expanded = !0),
            (g += " thread expanded"))
          : m.has_children &&
            (void 0 === m.expanded &&
              (1 == this.env.autoexpand_threads ||
                (2 == this.env.autoexpand_threads && m.unread_children)) &&
              (m.expanded = !0),
            (_ =
              '<div id="rcmexpando' +
              v.id +
              ...
              '">&nbsp;&nbsp;</div>'),
            (g += " thread" + (m.expanded ? " expanded" : ""))),
        s.unread_children && s.seen && !m.expanded && (g += " unroot"),
        s.flagged_children && !m.expanded && (g += " flaggedroot")),
      (d +=
        '<span id="msgicn' +
        v.id +
        '" class="' +
      ...
      (v.className = g),
      t.subject &&
        ((p = s.mbox == this.env.drafts_mailbox ? "compose" : "show"),
        (h = s.mbox == this.env.drafts_mailbox ? "_draft_uid" : "_uid"),
        ((g = { _mbox: s.mbox })[h] = e),
        (t.subject =
          '<a href="' +
          this.url(p, g) +
          '" onclick="return rcube_event.keyboard_only(event)" onmouseover="rcube_webmail.long_subject_title(this,' +
          (m.depth + 1) +
          ')" tabindex="-1"><span>' +
          t.subject +
          "</span></a>")),
      y))
        (r = y[n]),
          (a = { className: String(r).toLowerCase(), events: {} }),
          this.env.coltypes[r] &&
            this.env.coltypes[r].hidden &&
            (a.className += " hidden"),
          (r =
            "flag" == r
              ? ((o = s.flagged ? "flagged" : "unflagged"),
                (l = this.get_label(o)),
                '<span id="flagicn' +
                  v.id +
                  '" class="' +
                  ...
                  '"></span>')
              : "attachment" == r
              ? ((l = this.get_label("withattachment")),
                s.attachmentClass
                  ? '<span class="' +
                    s.attachmentClass +
                    '" title="' +
                    l +
                    '"></span>'
                  : "multipart/report" == s.ctype
                  ? '<span class="report"></span>'
                  : "multipart/encrypted" == s.ctype ||
                    "application/pkcs7-mime" == s.ctype
                  ? '<span class="encrypted"></span>'
                  : s.hasattachment ||
                    (!s.hasnoattachment &&
                      /application\/|multipart\/(m|signed)/.test(s.ctype))
                  ? '<span class="attachment" title="' + l + '"></span>'
                  : "&nbsp;")
              : "status" == r
              ? ((l = ""),
                s.deleted
                  ? (l = this.get_label((o = "deleted")))
                  : s.seen
                  ? (o = 0 < s.unread_children ? "unreadchildren" : "msgicon")
                  : (l = this.get_label((o = "unread"))),
                '<span id="statusicn' +
                  v.id +
                  '" class="' +
                  o +
              ...
              : "priority" == r
              ? 0 < s.prio && s.prio < 6
                ? ((l = this.get_label("priority") + " " + s.prio),
                  '<span class="prio' + s.prio + '" title="' + l + '"></span>')
                : "&nbsp;"
              : "folder" == r
          ...
          (a.innerHTML = r),
          v.cols.push(a);
      "widescreen" == b && (v = this.widescreen_message_row(v, e, m)),
        u.insert_row(v, i),
        i &&
          this.env.pagesize &&
          u.rowcount > this.env.pagesize &&
          ((e = u.get_last_row()), u.remove_row(e), u.clear_selection(e));
    }),
      ...
      return (
        ...
        $.each(this.env.widescreen_list_template, function () {
          if (ref.env.threading || "threads" != this.className) {
            ...
            for (
              this.className && (n.className = this.className), e = 0;
              this.cells && e < this.cells.length;
              e++
            )
        ...
        this.env.threading &&
          t.depth &&
          ((n = this.calculate_thread_padding(t.depth)),
    ...
    (this.set_list_options = function (e, t, s, i, n) {
      var a,
        r = {};
      if (
        (void 0 === t && (t = this.env.sort_col),
        (s = s || this.env.sort_order),
        (this.env.sort_col == t && this.env.sort_order == s) ||
          ((a = 1), this.set_list_sorting(t, s)),
        this.env.threading != i && ((a = 1), (r._threads = i)),
        n &&
          this.env.layout != n &&
          (this.triggerEvent("layout-change", {
        ...
        for (var o, l, c = [], h = this.env.listcols, d = 0; d < h.length; d++)
          (l = h[d]), -1 != (o = $.inArray(l, e)) && (c.push(l), delete e[o]);
        for (d = 0; d < e.length; d++) e[d] && c.push(e[d]);
        c.join() != h.join() && ((a = 1), (r._cols = c.join(",")));
      }
    ...
    (this.show_message = function (e, t, s) {
      ...
      e &&
        ((n = window),
        (a = this.params_from_uid(e, { _caps: this.browser_capabilities() })),
        s &&
          (i = this.get_frame_window(this.env.contentframe)) &&
          ((n = i), (a._framed = 1)),
        t && (a._safe = 1),
        ...
        s && (this.preview_id = e),
        s && 0 <= String(n.location.href).indexOf(a)
          ? this.show_contentframe(!0)
          : s || !this.env.message_extwin || this.env.extwin
          ? (t &&
              document.referrer &&
              window.history.replaceState &&
              window.history.replaceState({}, "", document.referrer),
            this.location_href(a, n, !0))
          : this.open_window(a, !0));
    }),
    (this.set_unread_message = function (e, t) {
      var s = this;
      (s =
        !(s = !s.message_list ? s.opener() : s) && window.parent
          ? parent.rcmail
          : s) &&
        s.message_list &&
        (!1 === s.set_message(e, "unread", !1) &&
          s.set_message(e + "-" + t, "unread", !1),
        0 < s.env.unread_counts[t] &&
          (--s.env.unread_counts[t],
          s.set_unread_count(
            t,
            s.env.unread_counts[t],
            "INBOX" == t && !s.is_multifolder_listing()
          )));
    }),
    (this.show_contentframe = function (e) {
      var t,
        s,
        i = this.env.contentframe;
      (t = this.get_frame_element(i)) &&
        (!e && (s = this.get_frame_window(i))
          ? s.location.href.indexOf(this.env.blankpage) < 0 &&
            (s.stop ? s.stop() : s.document.execCommand("Stop"),
            (s.location.href = this.env.blankpage))
          : bw.safari || bw.konq || $(t)[e ? "show" : "hide"]()),
        e || (this.unlock_frame(), delete this.preview_id);
    }),
    (this.get_frame_element = function (e) {
      var t;
      if (e && (t = document.getElementById(e))) return t;
    }),
    (this.get_frame_window = function (e) {
      e = this.get_frame_element(e);
      if (e && e.name && window.frames) return window.frames[e.name];
    }),
    (this.lock_frame = function (e) {
      var t = this.is_framed() ? parent.rcmail : this;
      t.env.frame_lock || (t.env.frame_lock = t.set_busy(!0, "loading")),
        e.frameElement &&
          $(e.frameElement).on("load.lock", function (e) {
            t.unlock_frame(), $(this).off("load.lock");
          });
    }),
    (this.unlock_frame = function () {
      this.env.frame_lock &&
        (this.set_busy(!1, null, this.env.frame_lock),
        (this.env.frame_lock = null));
    }),
    (this.list_page = function (e) {
      "next" == e
        ? (e = this.env.current_page + 1)
        : "last" == e
        ? (e = this.env.pagecount)
        : "prev" == e && 1 < this.env.current_page
        ? (e = this.env.current_page - 1)
        : "first" == e && 1 < this.env.current_page && (e = 1),
        0 < e &&
          e <= this.env.pagecount &&
          ((this.env.current_page = e),
          "addressbook" == this.task || this.contact_list
            ? this.list_contacts(this.env.source, this.env.group, e)
            : "mail" == this.task && this.list_mailbox(this.env.mailbox, e));
    }),
    ...
    (this.filter_mailbox = function (e) {
      var t, s;
      this.filter_disabled ||
        ((t = this.search_params(!1, e)),
        (s = this.set_busy(!0, "searching")),
        this.clear_message_list(),
        (this.env.current_page = 1),
        (this.env.search_filter = e),
        this.http_request("search", t, s),
        this.update_state({ _mbox: t._mbox, _filter: e, _scope: t._scope }));
    }),
    ...
    (this.list_mailbox = function (e, t, s, i, n) {
      ...
      "object" != typeof i && (i = {}),
        ...
        n ||
          (this.clear_message_list(),
          (e == this.env.mailbox && (e != this.env.mailbox || t || s)) ||
            (i._refresh = 1),
          this.select_folder(e, "", !0),
          this.unmark_folder(e, "recent", "", !0),
          (this.env.mailbox = e)),
        this.gui_objects.messagelist
          ? this.list_mailbox_remote(e, t, i)
          : ((s = this.get_frame_window(this.env.contentframe)) &&
              ((a = s), (i._framed = 1)),
    ...
    (this.list_mailbox_remote = function (e, t, s) {
      ...
      ((s = "object" != typeof s ? {} : s)._layout = this.env.layout),
        ...
        this.update_state({ _mbox: e, _page: t && 1 < t ? t : null });
    }),
    ...
    (this.expand_unread = function () {
      for (var e, t = this.message_list.tbody.firstChild; t; )
        1 == t.nodeType &&
          (e = this.message_list.rows[t.uid]) &&
          e.unread_children &&
          (this.message_list.expand_all(e), this.set_unread_children(e.uid)),
          (t = t.nextSibling);
      return !1;
    }),
    ...
    (this.init_threads = function (e, t) {
      if (t && t != this.env.mailbox) return !1;
      for (var s = 0, i = e.length; s < i; s++) this.add_tree_icons(e[s]);
      this.expand_threads();
    }),
    (this.add_tree_icons = function (e) {
      for (
        var t,
          ...
          a = [],
          r = [],
          o = this.message_list.rows,
          l = e ? (o[e] ? o[e].obj : null) : this.message_list.tbody.firstChild;
        l;
        ...
        if (1 == l.nodeType && (s = o[l.uid]))
          if (s.depth) {
            for (
              t = a.length - 1;
              0 <= t &&
              ((i = a[t].length) > s.depth
                ? ((n = i - s.depth),
                  2 & a[t][n] || (a[t][n] = a[t][n] ? a[t][n] + 2 : 2))
                : i == s.depth && (2 & a[t][0] || (a[t][0] += 2)),
              !(s.depth > i));
              t--
            );
            a.push(new Array(s.depth)), (a[a.length - 1][0] = 1), r.push(s.uid);
          } else {
            if (a.length) {
              for (t in a) this.set_tree_icons(r[t], a[t]);
              (a = []), (r = []);
            }
            if (e && l != o[e].obj) break;
          }
        l = l.nextSibling;
      }
      if (a.length) for (t in a) this.set_tree_icons(r[t], a[t]);
    }),
    (this.set_tree_icons = function (e, t) {
      for (var s = [], i = "", n = t.length, a = 0; a < n; a++)
        2 < t[a]
          ? s.push({ class: "l3", width: 15 })
          : 1 < t[a]
          ? s.push({ class: "l2", width: 15 })
          : 0 < t[a]
          ? s.push({ class: "l1", width: 15 })
          : s.length && !s[s.length - 1].class
          ? (s[s.length - 1].width += 15)
          : s.push({ class: null, width: 15 });
      for (a = s.length - 1; 0 <= a; a--)
        s[a].class
          ? (i += '<div class="tree ' + s[a].class + '" />')
          : (i += '<div style="width:' + s[a].width + 'px" />');
    ...
    (this.update_thread_root = function (e, t) {
      if (this.env.threading) {
        ...
        if (e != s) {
          ...
          if ("read" == t && e.unread_children) e.unread_children--;
          else if ("unread" == t && e.has_children)
            e.unread_children = (e.unread_children || 0) + 1;
          else if ("unflagged" == t && e.flagged_children) e.flagged_children--;
          else {
            if ("flagged" != t || !e.has_children) return;
    ...
    (this.update_thread = function (e) {
      if (!this.env.threading || !this.message_list.rows[e]) return 0;
      var t,
        s,
        i = 0,
        n = this.message_list,
      ...
      for (
        r.depth || i--,
          r.depth &&
            r.unread &&
            (a[(s = n.find_root(e))].unread_children--,
            this.set_unread_children(s)),
          r.depth &&
            r.flagged &&
            (a[(s = n.find_root(e))].flagged_children--,
            this.set_flagged_children(s)),
          s = r.parent_uid,
          r = r.obj.nextSibling;
        r;
        ...
        if (1 == r.nodeType && (t = a[r.uid])) {
          if (!t.depth || t.depth <= o) break;
          t.depth--,
            $("#rcmtab" + t.id)
              .width(15 * t.depth)
              .html(""),
            t.depth
              ? (t.depth == o && (t.parent_uid = s),
                t.unread && l.length && l[l.length - 1].unread_children++)
              : (i++,
                (t.parent_uid = 0),
                t.has_children &&
                  ($("#" + t.id + " .leaf")
                    .first()
                    .attr("id", "rcmexpando" + t.id)
                    .attr(
                      "class",
                      "none" != t.obj.style.display ? "expanded" : "collapsed"
                    )
                    .mousedown({ uid: t.uid }, function (e) {
      ...
      for (t = 0; t < l.length; t++)
        this.set_unread_children(l[t].uid), this.set_flagged_children(l[t].uid);
      return i;
    }),
    (this.delete_excessive_thread_rows = function () {
      for (
        var e = this.message_list.rows,
          t = this.message_list.tbody.firstChild,
          s = this.env.pagesize + 1;
        t;

      )
        1 == t.nodeType &&
          (r = e[t.uid]) &&
          (!r.depth && s && s--, s || this.message_list.remove_row(t.uid)),
          (t = t.nextSibling);
    }),
    (this.set_message_icon = function (e) {
      var t,
        s = "",
        e = this.message_list.rows[e];
      if (!e) return !1;
      e.icon &&
        ((t = "msgicon"),
        e.deleted
          ? ((t += " deleted"), (s += this.get_label("deleted") + " "))
          : e.unread
          ? ((t += " unread"), (s += this.get_label("unread") + " "))
          : e.unread_children && (t += " unreadchildren"),
        e.msgicon == e.icon &&
          (e.replied &&
            ((t += " replied"), (s += this.get_label("replied") + " ")),
          e.forwarded &&
            ((t += " forwarded"), (s += this.get_label("forwarded") + " ")),
          (t += " status")),
        $(e.icon).attr({ class: t, title: s })),
        e.msgicon &&
          e.msgicon != e.icon &&
          ((s = ""),
          (t = "msgicon"),
          ...
          e.forwarded &&
            ((t += " forwarded"), (s += this.get_label("forwarded") + " ")),
          $(e.msgicon).attr({ class: t, title: s })),
        e.flagicon &&
          ((t = e.flagged ? "flagged" : "unflagged"),
          (s = this.get_label(t)),
          $(e.flagicon).attr("class", t).attr({ "aria-label": s, title: s }));
    }),
    (this.set_message_status = function (e, t, s) {
      var i = this.message_list.rows[e];
      if (!i) return !1;
      "unread" == t
        ? i.unread != s && this.update_thread_root(e, s ? "unread" : "read")
        : "flagged" == t &&
          this.update_thread_root(e, s ? "flagged" : "unflagged"),
        -1 <
          $.inArray(t, [
            "unread",
            "deleted",
    ...
    (this.set_message = function (e, t, s) {
      ...
      t && this.set_message_status(e, t, s),
        -1 < $.inArray(t, ["unread", "deleted", "flagged"]) &&
          $(i.obj)[i[t] ? "addClass" : "removeClass"](t),
      ...
      if (e && "object" == typeof e) e.uids && (i = e.uids), (e = e.id);
        ...
        return (
          ...
          this.folder_selector(s, function (e, t) {
            ref.command("copy", { id: e, uids: i }, t, s, !0);
          })
        );
      !e ||
        e == this.env.mailbox ||
        ((e = this.selection_post_data({ _target_mbox: e, _uid: i }))._uid &&
          this.http_post(
            "copy",
            e,
            this.display_message("copyingmessage", "loading")
          ));
    }),
      ...
      if (e && "object" == typeof e) e.uids && (i = e.uids), (e = e.id);
        ...
        return (
          (i = this.env.uid
            ...
            : this.message_list.get_selection()),
          this.folder_selector(s, function (e, t) {
            ref.command("move", { id: e, uids: i }, t, s, !0);
          })
        );
      var t;
      e &&
        (e != this.env.mailbox || this.is_multifolder_listing()) &&
        ((t = !1),
        (e = this.selection_post_data({ _target_mbox: e, _uid: i }))._uid &&
          ("show" == this.env.action &&
            (t = this.set_busy(!0, "movingmessage")),
    ...
    (this.delete_messages = function (e) {
      ...
      return this.env.flag_for_deletion
        ? (this.mark_message("delete"), !1)
        : (!s ||
          this.env.mailbox == s ||
          (this.env.delete_junk &&
            this.env.junk_mailbox &&
            this.env.mailbox == this.env.junk_mailbox)
            ? this.permanently_remove_messages()
            : (t && t.modkey == SHIFT_KEY) ||
              (e && rcube_event.get_modifier(e) == SHIFT_KEY)
            ? this.confirm_dialog(
                this.get_label("deletemessagesconfirm"),
                "delete",
                function () {
    ...
    (this.permanently_remove_messages = function () {
      ...
      e._uid &&
        (this.with_selected_messages("delete", e), this.show_contentframe(!1));
    }),
    (this.with_selected_messages = function (e, t, s, i) {
      ...
      if (this.message_list) {
        var r,
          ...
          h = [],
          d = t._uid,
          _ = this.check_display_next();
        for (
          "*" === d
            ? (d = this.message_list.get_selection())
          ...
          (l = d[r]),
            this.env.threading &&
              ((n += this.update_thread(l)),
              (c = this.message_list.find_root(l)) != l &&
                $.inArray(c, h) < 0 &&
                h.push(c)),
            a && this.message_list.remove_row(l, _ && r == d.length - 1);
        for (
          !_ && a && this.message_list.clear_selection(), r = 0, o = h.length;
          r < o;
          r++
        )
      ...
      n < 0
        ? (t._count = -1 * n)
        : 0 < n && a && this.delete_excessive_thread_rows(),
        a || (t._refresh = 1),
        (s =
          s ||
          this.display_message(
            "move" == e ? "movingmessage" : "deletingmessage",
            "loading"
          )),
    ...
    (this.selection_post_data = function (e) {
      return (
        ...
        this.env.display_next &&
          this.env.next_uid &&
          (e._next_uid = this.env.next_uid),
        e
      );
    }),
    (this.check_display_next = function () {
      return (
        this.env.display_next && (this.preview_id || !this.env.contentframe)
      );
    }),
    (this.mark_message = function (e, t) {
      ...
      if (
        ...
        for (o.focus(), i = 0, s = a.length; i < s; i++)
          (n = a[i]),
            (("read" == e && o.rows[n].unread) ||
              ("unread" == e && !o.rows[n].unread) ||
              ("delete" == e && !o.rows[n].deleted) ||
              ("undelete" == e && o.rows[n].deleted) ||
              ("flagged" == e && !o.rows[n].flagged) ||
              ("unflagged" == e && o.rows[n].flagged)) &&
              r.push(n);
      else r = a;
    ...
    (this.toggle_read_status = function (e, t) {
      for (
        var s = t.length,
          i = this.selection_post_data({ _uid: t, _flag: e }),
          n = this.display_message("markingmessage", "loading"),
          a = 0;
        a < s;
        a++
      )
    ...
    (this.toggle_flagged_status = function (e, t) {
      for (
        var s = t.length,
          i = this.env.contentframe
            ? this.get_frame_window(this.env.contentframe)
            : window,
          n = this.selection_post_data({ _uid: t, _flag: e }),
          a = this.display_message("markingmessage", "loading"),
          r = 0;
        r < s;
        r++
      )
        this.set_message(t[r], "flagged", "flagged" == e);
      ("show" == this.env.action || 0 <= $.inArray(this.preview_id, t)) &&
        $(i.document.body)["flagged" == e ? "addClass" : "removeClass"](
          "status-flagged"
        ),
    ...
    (this.toggle_delete_status = function (e) {
      var t,
        ...
        i = !0,
        n = e.length,
        a = this.message_list ? this.message_list.rows : {};
      if (1 == n)
        return (
          !this.message_list || (a[e[0]] && !a[e[0]].deleted)
            ? this.flag_as_deleted(e)
            : this.flag_as_undeleted(e),
          !0
        );
      for (t = 0; t < n; t++)
      ...
      return i ? this.flag_as_undeleted(e) : this.flag_as_deleted(e), !0;
    }),
    (this.flag_as_undeleted = function (e) {
      for (
        var t = e.length,
          s = this.selection_post_data({ _uid: e, _flag: "undelete" }),
          i = this.display_message("markingmessage", "loading"),
          n = 0;
        n < t;
        n++
      )
    ...
    (this.flag_as_deleted = function (e) {
      for (
        var t = [],
          s = this.selection_post_data({ _uid: e, _flag: "delete" }),
          i = this.display_message("markingmessage", "loading"),
          n = this.message_list,
          a = n ? n.rows : {},
          r = 0,
          o = this.check_display_next(),
          l = 0,
          c = e.length;
        l < c;
        l++
        ...
        (uid = e[l]),
          a[uid] &&
            (a[uid].unread && (t[t.length] = uid),
            this.env.skip_deleted
              ? ((r += this.update_thread(uid)),
                n.remove_row(uid, o && l == n.get_selection(!1).length - 1))
              : this.set_message(uid, "deleted", !0));
      this.env.skip_deleted &&
        n &&
        ((o && n.rowcount) || n.clear_selection(),
        r < 0
          ? (s._count = -1 * r)
          : 0 < r && this.delete_excessive_thread_rows()),
        t.length && (s._ruid = this.uids_to_list(t)),
        this.env.skip_deleted &&
          this.env.display_next &&
          this.env.next_uid &&
          (s._next_uid = this.env.next_uid),
        this.http_post("mark", s, i);
    }),
    (this.flag_deleted_as_read = function (e) {
      for (
        var t,
          s = this.message_list ? this.message_list.rows : {},
          i = 0,
          n = (e = "string" == typeof e ? e.split(",") : e).length;
        i < n;
        i++
      )
      ...
      $(a)
        ...
        .on("focus", function (e) {
          ...
          (t = '<ul class="toolbarmenu menu">' + t + "</ul>"),
            ref.pagejump ||
              (ref.pagejump = $(
                '<div id="pagejump-selector" class="popupmenu"></div>'
              )
        ...
        .on("keydown keyup click", function (e) {
          var t = $("#pagejump-selector"),
            s = $("ul", t),
            i = $("li", s),
            n = (s.height(), parseInt(this.value));
          if (
            27 != e.which &&
            9 != e.which &&
            13 != e.which &&
          ...
          if ("keydown" == e.type)
            if (40 == e.which) i.length > n && (this.value = n += 1);
            else if (38 == e.which)
              1 < n && i.length > n - 1 && (this.value = --n);
            else {
              if (13 == e.which) return $(this).change();
          ...
          $("li.selected", s).removeClass("selected"),
            (e = $(i[n - 1])).length &&
              (e.addClass("selected"),
              $("#pagejump-selector").scrollTop(
                (s.height() / i.length) * (n - 1) - t.height() / 2
              ));
        })
        .on("change", function (e) {
          var t = parseInt(this.value);
          t &&
            t != ref.env.current_page &&
            !ref.busy &&
            (ref.hide_menu("pagejump-selector", e), ref.list_page(t));
        });
    }),
    (this.update_pagejumper = function () {
      $("input.rcpagejumper")
        .val(this.env.current_page)
        .prop("disabled", this.env.pagecount < 2);
    }),
    (this.check_mailvelope = function (e) {
      window.mailvelope
        ? this.mailvelope_load(e)
    ...
    (this.mailvelope_load = function (t) {
      function s(e) {
        (ref.mailvelope_keyring = e), ref.mailvelope_init(t, e);
      }
      ...
      mailvelope
        ...
        .then(s, function (e) {
          i
            ? mailvelope.createKeyring(i).then(s, function (e) {
                console.error(e);
              })
            : console.error(e);
        });
    ...
    (this.mailvelope_init = function (e, t) {
      var s, i, n, a, r, o;
      window.mailvelope &&
        ("show" == e || "preview" == e || "print" == e
          ? this.env.is_pgp_content
            ? ((s = $(this.env.is_pgp_content).text()),
              ref.mailvelope_display_container(this.env.is_pgp_content, s, t))
            : this.env.pgp_mime_part &&
              ((i = this.display_message("loadingdata", "loading")),
          ...
          ? (this.env.compose_commands.push("compose-encrypted"),
            ...
            this.env.pgp_mime_message
              ? ((o = this.set_busy(!0, this.get_label("loadingdata"))),
                $.ajax({
                  type: "GET",
                  ...
                  success: function (e) {
                    ref.set_busy(!1, null, o),
                      r &&
                        (ref.command("toggle-editor", {
                          html: !1,
                          noconvert: !0,
                        }),
                        $("#" + ref.env.composebody).val("")),
                      ref.compose_encrypted({ quotedMail: e }),
            ...
            this.addEventListener("actionafter", function (e) {
              e.ret &&
                "toggle-editor" == e.action &&
                (ref.enable_command("compose-encrypted", !e.props.html),
                a &&
                  ref.enable_command(
    ...
    (this.compose_encrypted_signed = function (e) {
      ((e = e || {}).signMsg = !0), this.compose_encrypted(e);
    }),
    (this.compose_encrypted = function (e) {
      var t,
        s = $("#" + this.env.composebody).parent();
      ref.mailvelope_editor
        ? ((ref.mailvelope_editor = null),
          ref.set_button("compose-encrypted", "act"),
          s
            .removeClass("mailvelope")
            .find("iframe:not([aria-hidden=true])")
            .remove(),
          ...
          ref.enable_command(
            ...
            !!(
              ref.env.signatures &&
              ref.env.identity &&
              ref.env.signatures[ref.env.identity]
            )
          ),
          ref.triggerEvent("compose-encrypted", { active: !1 }))
        : (this.spellcheck_state() && this.editor.spellcheck_stop(),
          (t = e.quotedMail
            ? { quotedMail: e.quotedMail, quotedMailIndent: !1 }
            : { predefinedText: $("#" + this.env.composebody).val() }),
          e.signMsg && (t.signMsg = e.signMsg),
          "reply" == this.env.compose_mode &&
            ((t.quotedMailIndent = !0),
            (t.quotedMailHeader = this.env.compose_reply_header)),
          mailvelope
            .createEditorContainer(
              "#" + s.attr("id"),
              ref.mailvelope_keyring,
              t
            )
            .then(
              function (e) {
                (ref.mailvelope_editor = e),
                  ...
                  ref.triggerEvent("compose-encrypted", { active: !0 }),
                  $.isEmptyObject(ref.env.attachments) ||
                    (("draft" == ref.env.compose_mode &&
                      1 == Object.keys(ref.env.attachments).length &&
                      "encrypted.asc" ==
                        ref.env.attachments[Object.keys(ref.env.attachments)[0]]
                          .name) ||
    ...
    (this.mailvelope_submit_messageform = function (a, r) {
        ...
        for (
          var s,
            i = $('[name="_' + t + '"]')
              .val()
              .trim();
          i.length && rcube_check_email(i, !0);
      ...
      var l = 0 < o.length;
      return (
        ref.mailvelope_keyring.validKeyForAddress(o).then(
          function (e) {
            var s = [];
            if (
              ($.each(e, function (e, t) {
              ...
              return (
                ref.simple_dialog(
                  ref.get_label("nopubkeyfor").replace("$email", s.join(", ")) +
                    "<p>" +
                    ref.get_label("searchpubkeyservers") +
                    "</p>",
                  "encryptedsendialog",
                  function () {
            ...
            if (!l)
              return (
                o.length ||
                  ref.alert_dialog(
                    ref.get_label("norecipientwarning"),
                    function () {
                      $("[name='_to']").focus();
                    }
                  ),
            ...
            $.each(ref.env.identities, function (e, t) {
              ...
              ref.mailvelope_keyring.validKeyForAddress(i).then(
                function (e) {
                  return (
                    (valid_sender = null),
                    $.each(e, function (e, t) {
                      if (!1 !== t && ((valid_sender = e), valid_sender == n))
                        return !1;
                    }),
                    !(
                      !valid_sender &&
                      !confirm(ref.get_label("nopubkeyforsender"))
                    ) &&
                      (o.push(valid_sender),
                      void ref.mailvelope_editor.encrypt(o).then(
                        function (e) {
                          var t = ref.gui_objects.messageform,
                            s = $("[name='_pgpmime']", t),
                            i = ref.set_busy(
                              !0,
                              a || r ? "savingmessage" : "sendingmessage"
                            );
                          (t.target = ref.get_save_target(i)),
                            ...
                            (s = !s.length
                              ? $(
                                  '<input type="hidden" name="_pgpmime">'
                                ).appendTo(t)
                              : s).val(e),
                            t.submit();
                        },
    ...
    (this.mailvelope_display_container = function (t, e, s, i) {
      ...
      mailvelope
        .createDisplayContainer(t, e, s, { senderAddress: this.env.sender })
        .then(function (e) {
        ...
        $.when
          ...
          .then(function () {
            ...
            $.each(arguments, function (e, t) {
              ...
              i.length &&
                ref.display_message(
                  ref.get_label("nopubkeyfor").replace("$email", i.join(", ")),
                  "warning"
                );
          })
          .fail(function () {
    ...
    (this.mailvelope_key_import_dialog = function (e, a) {
      ...
      $.each(e, function (e, t) {
        ...
        t.revoked && s.addClass("revoked"),
          ...
          s.append(
            $("<a>")
              .text(t.keyid.substr(-8).toUpperCase())
              .attr({ href: t.info, target: "_blank", tabindex: "-1" })
          ),
          s.append(
            $("<label>").addClass("keylen").text(ref.get_label("keylength"))
          ),
          ...
          t.expirationdate &&
            (s.append(
              $("<label>")
                .addClass("keyexpired")
                .text(ref.get_label("keyexpired"))
            ),
            s.append(
              $("<span>").text(new Date(1e3 * t.expirationdate).toDateString())
            )),
          t.revoked &&
            s.append(
              $("<span>")
                .addClass("keyrevoked")
                .text(ref.get_label("keyrevoked"))
            );
        ...
        $.each(t.uids, function (e, t) {
          ...
          s.append(
            $("<button>")
              ...
              .prop("disabled", t.revoked || t.disabled || t.expired)
          ),
          n.append(s);
      }),
        ref.simple_dialog(
          ...
          e.get(i, function (e, t) {
            ref.hide_message(n),
              t
                ...
                : a
                ? a(e)
                : ref.mailvelope_keyring.importPublicKey(e).then(
                    function (e) {
                      "REJECTED" === e ||
                        ((e = i.substr(-8).toUpperCase()),
                        s.closest(".key").fadeOut(),
                        ref.display_message(
                          ref.get_label("keyimportsuccess").replace("$key", e),
                          "confirmation"
                        ));
                    },
                    function (e) {
    ...
    (this.mailvelope_identity_keygen = function () {
      ...
      i.length &&
        n &&
        this.mailvelope_keyring.createKeyGenContainer &&
        this.mailvelope_keyring
          .validKeyForAddress([n])
          .then(function (e) {
            var s = [];
            if (e && e[n] && Array.isArray(e[n].keys)) {
              for (var t = [], i = 0; i < e[n].keys.length; i++)
                t.push(
                  (function (t) {
                    return ref.mailvelope_keyring
                      .hasPrivateKey(t.fingerprint)
                      .then(function (e) {
                        e && s.push(t);
                      });
                  })(e[n].keys[i])
          ...
          .then(function (e) {
            var s,
              t = i.find(".identity-encryption-block").empty();
            e && e.length
              ? ($("<p>")
                  .text(
                    ref
                      .get_label("encryptionprivkeysinmailvelope")
                      .replace("$nr", e.length)
                  )
                  .appendTo(t),
                  ...
                  $("<li>")
                    ...
                    .append(
                      $("<strong>")
                        ...
                        .text(String(t.fingerprint).toUpperCase())
                    )
                    .append(
                      $("<span>")
                        .addClass("identity")
              ...
              : $("<p>")
                  .text(ref.get_label("encryptionnoprivkeysinmailvelope"))
                  .appendTo(t),
              $("<button>")
                .attr("type", "button")
              ...
              i.show(),
              ref.triggerEvent("identity-encryption-show", { container: i });
          })
          .catch(function (e) {
    ...
    (this.mailvelope_show_keygen_container = function (t, s) {
      var e = new Date().getTime(),
        i = {
          userIds: [
            {
              email: s,
              fullName: $(ref.gui_objects.editform)
                .find(".ff_name")
                .val()
                .trim(),
            },
      ...
      $("<div>")
        .attr("id", "mailvelope-keygen-container-" + e)
        .css({ height: "245px", marginBottom: "10px" })
        .appendTo(t.empty()),
        this.mailvelope_keyring
          .createKeyGenContainer("#mailvelope-keygen-container-" + e, i)
          .then(function (e) {
            ...
            $("<button>")
              ...
              .on("click", function () {
                ...
                e.generate()
                  .then(function (e) {
                    "string" == typeof e &&
                      0 < e.indexOf("BEGIN PGP") &&
                      (ref.display_message(
                        ref
                          .get_label("keypaircreatesuccess")
                          .replace("$identity", s),
                        "confirmation"
                      ),
              ...
              ref.triggerEvent("identity-encryption-update", { container: t });
          })
          .catch(function (e) {
    ...
    (this.mdn_request_dialog = function (e, t) {
      var i = { action: "mark", data: { _uid: e, _mbox: t, _flag: "mdnsent" } },
        t = [
          {
      ...
      this.env.mdn_request_save &&
        t.unshift({
          text: this.get_label("sendalwaysto").replace(
            "$email",
            this.env.mdn_request_sender.mailto
          ),
          class: "mainaction send",
          click: function (e, t, s) {
        ...
        this.show_popup_dialog(
          this.get_label("mdnrequest"),
          this.get_label("sendreceipt"),
          t,
          {
            close: function (e, t) {
              ref.http_post(i.action, i.data), $(this).remove();
            },
          }
        );
    }),
    ...
    (this.purge_mailbox = function (s) {
      return (
        this.confirm_dialog(
          this.get_label("purgefolderconfirm"),
          "delete",
          function () {
            var e,
              t = { _mbox: s };
            s == ref.env.mailbox &&
              ((e = ref.set_busy(!0, "loading")), (t._reload = 1)),
    ...
    (this.mark_all_read = function (e, s) {
      var n,
        ...
        a = [],
        i = this.message_list,
        r = e || this.env.mailbox,
        e = { _uid: "*", _flag: "read", _mbox: r, _folders: s };
      if ("string" != typeof s) {
        if (!(n = this.mark_all_read_state(r))) return;
        if (1 < n)
          return (
            $.each({ cur: 1, sub: 2, all: 4 }, function (e, t) {
              var s = "readallmode" + e,
                i = $("<label>")
                  .attr("for", s)
                  .text(ref.get_label("folders-" + e)),
                t = $("<input>").attr({
                  type: "radio",
                  value: e,
                  name: "mode",
            ...
            void this.simple_dialog(
              t,
              this.get_label("markallread"),
              function () {
                return ref.mark_all_read(r, $("input:checked", t).val()), !0;
              },
      ...
      $.each(i ? i.rows : [], function (e, t) {
        t.unread &&
          ((t = ref.env.messages[e].mbox),
          ("all" == s ||
            t == ref.env.mailbox ||
            ("sub" == s &&
              t.startsWith(ref.env.mailbox + ref.env.delimiter))) &&
            ref.set_message(e, "unread", !1));
      }),
        this.http_post(
          "mark",
          e,
          this.display_message("markingmessage", "loading")
        );
    }),
    ...
    (this.bounce = function (e, t, s) {
      var i = this.get_single_uid(),
        ...
        a = function () {
          ...
          return { rc: e, form: e.gui_objects.messageform };
        },
        r = function () {
          var e = {},
            t = a();
          $.each($(t.form).serializeArray(), function () {
            ...
            delete e._task,
            (e._to || e._cc || e._bcc) &&
              (ref.http_post("bounce", e, ref.set_busy(!0, "sendingmessage")),
              n.dialog("close"));
        };
      return (
        this.hide_menu("forwardmenu", s),
        (n = this.simple_dialog(
          n,
          this.gettext("bouncemsg"),
          function () {
            var e = a();
            return (
              "object" == typeof e.form &&
              !!e.rc.check_compose_address_fields(r, e.form) &&
              r()
            );
          },
          { button: "bounce", width: 400, height: 300 }
        )),
        !0
      );
    }),
    (this.open_compose_step = function (e) {
      ...
      this.env.compose_extwin && !this.env.extwin
        ? this.open_window(e)
        : (this.redirect(e),
          this.env.extwin &&
            window.resizeTo(
              Math.max(this.env.popup_width, $(window).width()),
              $(window).height() + 24
            ));
    }),
    (this.init_messageform = function () {
      ...
      var e,
        ...
        i = $("[name='_to']"),
        n = $("[name='_subject']"),
        a = $("[name='_message']").get(0),
        r = "1" == $("[name='_is_html']").val(),
        o = this.opener();
      o &&
        "compose" == o.env.action &&
        (setTimeout(function () {
          1 < opener.history.length
            ? opener.history.back()
            : o.redirect(o.get_task_url("mail"));
        }, 100),
        (this.env.opened_extwin = !0)),
        r ||
          (a.value && void 0 !== a.defaultValue && (a.value = a.defaultValue),
          (t =
            this.env.top_posting && this.env.compose_mode ? 0 : a.value.length),
          "select-one" == s.prop("type") &&
            (this.set_caret_pos(a, 0), this.change_identity(s[0])),
    ...
    (this.init_messageform_inputs = function (e) {
      var t,
        s = $("[name='_to']"),
        i = ["cc", "bcc", "replyto", "followupto"];
      for (t in (this.init_address_input_events(s), i))
        this.init_address_input_events($("[name='_" + i[t] + "']"));
      return (e = e || s), $(e).focus().get(0);
    }),
    (this.compose_restore_dialog = function (e, t) {
      ...
      for (
        var i,
          n,
          a = this.local_storage_get_item("compose.index", []),
          r = e || 0;
        r < a.length;
        r++
      )
        if (
          ...
          if (
            (!this.env.draft_id ||
              !n.draft_id ||
              n.draft_id == this.env.draft_id) &&
            (!this.env.reply_msgid || n.reply_msgid == this.env.reply_msgid) &&
            n.changed &&
            n.session != this.env.session_id
          ) {
            this.show_popup_dialog(
              this.get_label("restoresavedcomposedata")
                .replace("$date", new Date(n.changed).toLocaleString())
                .replace("$subject", n._subject)
                .replace(/\n/g, "<br/>"),
              ...
              [
                ...
                },
                {
                  ...
                  class: "delete",
                  click: function () {
                    ref.remove_compose_data(i), $(this).dialog("close"), s(r);
                  },
                },
                {
                  text: this.get_label("ignore"),
    ...
    (this.init_address_input_events = function (e, t) {
      ...
      e = function (e) {
        (ref.ksearch_pane && e.target === ref.ksearch_pane.get(0)) ||
          ref.ksearch_hide();
      };
      $(document).on("click", e), document.addEventListener("scroll", e, !0);
    }),
    (this.submit_messageform = function (e, t) {
      var s = this.gui_objects.messageform;
      if (s) {
        if (!t && this.env.is_sent)
          return this.simple_dialog(
            this.get_label("messageissent"),
            "",
            function () {
              return ref.submit_messageform(!1, !0), !0;
            }
          );
    ...
    (this.compose_recipient_select = function (e) {
      for (var t, s = 0, i = e.get_selection(), n = 0; n < i.length; n++)
        (t = i[n]), this.env.contactdata[t] && s++;
      this.enable_command("add-recipient", s);
    }),
    (this.compose_add_recipient = function (e) {
      e =
        e ||
        ((e = $(this.env.focused_field).filter(":visible")).length
          ? e.attr("id").replace("_", "")
          : "to");
      var t,
        s = [],
        i = $("#_" + e),
        n = this.contact_list.get_selection();
      if (this.contact_list && n.length)
        for (var a, r, o, l = 0; l < n.length; l++)
          (r = n[l]) &&
            (a = this.env.contactdata[r]) &&
            ((o = "​" + (a.name || a) + "​"),
            s.push(o),
            "E" == r.charAt(0) &&
              i.length &&
              ((r = r.substr(1)),
              (this.group2expand[r] = { name: o, input: i.get(0) }),
              this.http_request(
                "group-expand",
                { _source: a.source || this.env.source, _gid: r },
                !1
              )));
      return (
        s.length &&
          ...
          this.triggerEvent("add-recipient", { field: e, recipients: s })),
        s.length
      );
    }),
    (this.check_compose_input = function (e) {
      ...
      for (t in this.env.attachments)
        if (
          "object" == typeof this.env.attachments[t] &&
          !this.env.attachments[t].complete
        )
          return this.alert_dialog(this.get_label("notuploadedwarning")), !1;
      if (this.env.nosubject_warned || "" != s.val())
        return this.mailvelope_editor ||
          this.editor.get_content() ||
          confirm(this.get_label("nobodywarning"))
          ? !!this.check_compose_address_fields(e) && (this.editor.save(), !0)
          : (this.editor.focus(), !1);
      var i = $("<input>").attr({
          type: "text",
          size: 40,
        ...
        n = $('<div class="prompt">')
          .append(
            $('<p class="message">').text(this.get_label("nosubjectwarning"))
          )
          .append(i),
        a = this.show_popup_dialog(
          n,
          ...
          [
            {
              ...
              click: function () {
                s.val(i.val()),
                  a.dialog("close"),
                  ref.check_compose_input(e) && ref.command(e, { nocheck: !0 });
              },
            },
            {
    ...
    (this.check_compose_address_fields = function (t, e) {
      e = e || window.document;
      var s,
        i = this.env.max_disclosed_recipients,
        n = $("[name='_to']", e),
        a = $("[name='_cc']", e),
        r = $("[name='_bcc']", e),
        o = $("[name='_from']", e),
      ...
      if (
        i &&
        !this.env.disclosed_recipients_warned &&
        rcube_check_email((s = e([n, a])), !0, !0) > i
      ) {
        function l(e) {
          e &&
            ((e = r.val()),
            ...
            a.val("").change()),
            c.dialog("close"),
            "function" == typeof t ? t() : t && ref.command(t, { nocheck: !0 });
        }
        var c = this.show_popup_dialog(
    ...
    (this.toggle_editor = function (e, t, s) {
      ...
      return (
        $("[name='_is_html']").val("html" == e ? 1 : 0),
        s.is("[type=checkbox]") ? s.prop("checked", "html" == e) : s.val(e),
        i
      );
    }),
    (this.insert_response = function (e) {
      this.editor.replace(this.env.textresponses[e]),
        this.display_message("responseinserted", "confirmation");
    }),
    (this.save_response = function () {
      var e = {},
        t = this.editor.get_content({
          selection: !0,
          format: "text",
          nosig: !0,
        }),
        s =
          '<form class="propform"><div class="prop block"><label for="ffresponsename">' +
          this.get_label("responsename") +
          '</label><input type="text" name="name" id="ffresponsename" size="40" /></div><div class="prop block"><label for="ffresponsetext">' +
          this.get_label("responsetext") +
          '</label><textarea name="text" id="ffresponsetext" cols="40" rows="8"></textarea></div></form>';
      (e[this.get_label("save")] = function (e) {
        var t = $("#ffresponsename").val(),
          s = $("#ffresponsetext").val();
        if (!s) return $("#ffresponsetext").select(), !1;
        var t = t || s.replace(/[\r\n]+/g, " ").substring(0, 40),
          i = ref.display_message("savingresponse", "loading");
        ref.http_post(
          "settings/responses",
          { _insert: 1, _name: t, _text: s },
          i
        ),
          $(this).dialog("close");
      }),
        (e[this.get_label("cancel")] = function () {
          $(this).dialog("close");
        }),
        this.show_popup_dialog(s, this.get_label("newresponse"), e, {
          button_classes: ["mainaction save", "cancel"],
        }),
        $("#ffresponsetext").val(t),
        $("#ffresponsename").select();
    }),
    (this.add_response_item = function (e) {
      var t,
        s = e.key;
      (this.env.textresponses[s] = e),
        this.gui_objects.responseslist &&
          ((t = $("<li>").appendTo(this.gui_objects.responseslist)),
          $("<a>")
            .addClass("insertresponse active")
            .attr({ href: "#", rel: s, tabindex: "0" })
            .html(this.quote_html(e.name))
            .appendTo(t)
            .mousedown(function (e) {
              return rcube_event.cancel(e);
            })
            .on("mouseup keypress", function (e) {
              if ("mouseup" == e.type || 13 == rcube_event.get_keycode(e))
                return (
                  ref.command("insert-response", $(this).attr("rel")),
                  $(document.body).trigger("mouseup"),
                  rcube_event.cancel(e)
          ...
          $(this.gui_objects.responseslist)
            .find("li > a.insertresponse.placeholder")
            .parent()
            .remove());
    }),
    ...
    (this.delete_response = function (e) {
      ...
      !e &&
        this.responses_list &&
        ((t = this.responses_list.get_selection()), (e = t[0])),
        e &&
          this.confirm_dialog(
            this.get_label("deleteresponseconfirm"),
            "delete",
            function () {
              ref.http_post("settings/delete-response", { _key: e }, !1);
            }
          );
    }),
    (this.spellcheck_state = function () {
      ...
      return (
        $.each(this.buttons.spellcheck || [], function (e, t) {
    ...
    (this.set_draft_id = function (e) {
      ...
      e &&
        e != this.env.draft_id &&
        ((t =
          this.opener(!(t = { task: "mail", action: "" }), t) ||
          this.opener(!0, t)) &&
          t.env.mailbox == this.env.drafts_mailbox &&
          t.command("checkmail"),
        (this.env.draft_id = e),
    ...
    (this.get_save_target = function (e) {
      return (
        this.dummy_iframe("savetarget", "about:blank").on(
          "load error",
          function () {
            e &&
              0 ==
                $(this)
                  .contents()
                  .find('meta[name="generator"][content="Roundcube"]').length &&
              (ref.iframe_loaded(e), ref.display_message("connerror", "error")),
              $(this).remove();
          }
        ),
        "savetarget"
      ...
      this.env.draft_autosave &&
        ...
        !this.local_save_timer &&
          ...
          (this.local_save_timer = setInterval(function () {
            ref.compose_type_activity > ref.compose_type_activity_last &&
              (ref.save_compose_form_local(),
        ...
        window.onbeforeunload ||
          (window.onbeforeunload = function () {
            if (
              ...
              ref.cmp_hash != ref.compose_field_hash()
            )
    ...
    (this.compose_field_hash = function (e) {
      for (
        var t, s, i = "", n = ["to", "cc", "bcc", "subject"], a = 0;
        a < n.length;
        a++
      )
        (s = $('[name="_' + n[a] + '"]').val()) && (i += s + ":");
      for (t in ((i += this.editor.get_content({ refresh: !1 })),
      this.env.attachments))
        i += t;
      return (
        this.mailvelope_editor && (i += ";" + new Date().getTime()),
        e && (this.cmp_hash = i),
        i
      );
    }),
    (this.save_compose_form_local = function () {
      var s, i, e, t;
      this.env.save_localstorage &&
        ((s = { session: this.env.session_id, changed: new Date().getTime() }),
        (i = !0),
        this.editor.save(),
        this.env.draft_id && (s.draft_id = this.env.draft_id),
        this.env.reply_msgid && (s.reply_msgid = this.env.reply_msgid),
        $("input, select, textarea", this.gui_objects.messageform).each(
          function (e, t) {
            switch (t.tagName.toLowerCase()) {
              case "input":
                if (
                  "button" == t.type ||
                  "submit" == t.type ||
                  ("hidden" == t.type && "_is_html" != t.name)
                )
                  break;
                (s[t.name] =
                  "checkbox" != t.type || t.checked ? $(t).val() : ""),
              ...
              case "select":
                ...
                break;
              default:
                (s[t.name] = $(t).val()), "" != s[t.name] && (i = !1);
            }
          }
        ),
        i ||
          ((e = this.local_storage_get_item("compose.index", [])),
    ...
    (this.restore_compose_form = function (e, t) {
      ...
      e &&
        ...
        ($.each(e, function (e, t) {
          "_" == e[0] &&
            ((e = $("[name=" + e + "]"))[0] && "checkbox" == e[0].type
              ? e.prop("checked", "" != t)
              : e.val(t).change());
        }),
        (("1" == e._is_html && !t) || ("1" != e._is_html && t)) &&
          this.command("toggle-editor", {
    ...
    (this.remove_compose_data = function (s) {
      ...
      0 <= $.inArray(s, e) &&
        (this.local_storage_remove_item("compose." + s),
        this.local_storage_set_item(
          "compose.index",
          $.grep(e, function (e, t) {
            return e != s;
          })
    ...
    (this.clear_compose_data = function () {
      for (
        var e = this.local_storage_get_item("compose.index", []), t = 0;
        t < e.length;
        t++
      )
    ...
    (this.change_identity = function (e, t) {
      ...
      return (
        s
          ? (this.enable_command("insert-sig", !0),
            this.env.compose_commands.push("insert-sig"),
            (s = !0))
          : this.enable_command("insert-sig", !1),
        this.env.identities_initialized ||
        ((this.env.identities_initialized = !0),
        this.env.show_sig_later && (this.env.show_sig = !0),
        !this.env.opened_extwin)
          ? ($.each(["replyto", "bcc"], function () {
              var e,
                t =
                  r && ref.env.identities[r] ? ref.env.identities[r][this] : "",
                s =
                  a && ref.env.identities[a] ? ref.env.identities[a][this] : "",
                i = $('[name="_' + this + '"]'),
                n = i.val();
              t &&
                n &&
                ((e = new RegExp("\\s*" + RegExp.escape(t) + "\\s*")),
                (n = n.replace(e, ""))),
                (n = String(n)
                  .replace(/[,;]\s*[,;]/g, ",")
                  .replace(/^[\s,;]+/, "")),
      ...
      if (e) {
        ...
        return (
          $("input", e).each(function () {
            if (this.files) {
              i = this.name;
              for (var e = 0; e < this.files.length; e++) n.push(this.files[e]);
            }
          }),
          this.file_upload(
            n,
            { _id: this.env.compose_id || "" },
            { name: i, action: t, lock: s }
          )
        );
      }
    }),
    (this.add2attachment_list = function (e, t, s) {
      if (
        (s &&
          this.triggerEvent("fileuploaded", { name: e, attachment: t, id: s }),
      ...
      !t.complete &&
        t.html.indexOf("<") < 0 &&
        (t.html = '<span class="uploading">' + t.html + "</span>"),
        !t.complete &&
          this.env.loadingicon &&
          (t.html =
            '<img src="' +
            this.env.loadingicon +
            '" alt="" class="uploading" />' +
            t.html),
        t.complete ||
          ((i = this.get_label("cancel")),
          (t.html =
            '<a title="' +
            i +
            '" onclick="return rcmail.cancel_attachment_upload(\'' +
            e +
            '\');" href="#cancelupload" class="cancelupload">' +
            (this.env.cancelicon
              ? '<img src="' + this.env.cancelicon + '" alt="' + i + '" />'
        ...
        s && (a = document.getElementById(s))
          ? n.replaceAll(a)
          : n.appendTo(this.gui_objects.attachmentlist);
      var a = $(this.gui_objects.attachmentlist).attr("data-tabindex") || "0";
      return (
        n.find("a").attr("tabindex", a),
    ...
    (this.remove_from_attachment_list = function (e) {
      delete this.env.attachments[e], $("#" + e).remove();
    }),
    (this.remove_attachment = function (e) {
      return (
        e &&
          this.env.attachments[e] &&
    ...
    (this.cancel_attachment_upload = function (e) {
      return (
        e &&
          this.uploads[e] &&
          (this.remove_from_attachment_list(e), this.uploads[e].abort()),
        !1
      );
    }),
    (this.rename_attachment = function (t) {
      var s,
        e,
        i = this.env.attachments[t];
      i &&
        ((s = $("<input>").attr({ type: "text", size: 50 }).val(i.name)),
        ...
        this.simple_dialog(e, "attachmentrename", function () {
          ...
          if ((e = s.val()) && e != i.name)
            return (
              ref.http_post(
                "rename-attachment",
                { _id: ref.env.compose_id, _file: t, _name: e },
    ...
    (this.add_contact = function (e, t) {
      e && this.http_post("addcontact", { _address: e, _reload: t });
    }),
    (this.qsearch = function (e) {
      if (
        ...
        var t = this.set_busy(!0, "searching"),
          ...
          e =
            "compose" == this.env.action && this.contact_list
              ? "search-contacts"
              : "search";
        return (
          this.message_list
          ...
          (this.env.qsearch = { lock: t, request: s }),
          this.enable_command(
            "set-listmode",
            this.env.threads && "base" == (this.env.search_scope || "base")
          ),
          !0
        );
      }
    ...
    (this.search_params = function (e, t) {
      var s,
        i = {},
        n = [],
        a = this.env.search_mods,
        r = this.env.search_scope || "base",
        o = this.env.mailbox;
      if (
        (!t &&
          this.gui_objects.search_filter &&
          (t = this.gui_objects.search_filter.value),
        !e &&
          this.gui_objects.qsearchbox &&
          (e = this.gui_objects.qsearchbox.value),
        this.gui_objects.search_interval &&
          (i._interval = $(this.gui_objects.search_interval).val()),
        e && ((i._q = e), (a = a && this.message_list ? a[o] || a["*"] : a)))
      ) {
        for (s in a) n.push(s);
        i._headers = n.join(",");
      }
      return (
        (i._layout = this.env.layout),
        (i._filter = t),
        (i._scope = r),
        (i._mbox = o),
        i
    ...
    (this.reset_qsearch = function (e) {
      this.gui_objects.qsearchbox && (this.gui_objects.qsearchbox.value = ""),
        ...
        e && ((this.env.search_scope = "base"), this.reset_search_filter()),
    ...
    (this.is_multifolder_listing = function () {
      return void 0 !== this.env.multifolder_listing
        ? this.env.multifolder_listing
        : this.env.search_request &&
            "base" != (this.env.search_scope || "base");
    }),
    (this.sent_successfully = function (e, t, s, i) {
      ...
      this.display_message(t, e),
        (this.compose_skip_unsavedcheck = !0),
        this.env.extwin
          ? (i || this.lock_form(this.gui_objects.messageform),
            (n =
              this.opener(!(n = { task: "mail", action: "" }), n) ||
              this.opener(!0, n)) &&
              (n.display_message(t, e),
    ...
    (this.image_scale = function (e) {
      ...
      (this.image_style.scale = Math.max(0.1, t + 0.1 * ("-" == e ? -1 : 1))),
        this.apply_image_style();
    }),
    (this.apply_image_style = function () {
      ...
      $("#image-style", e).remove(),
        $.each({ scale: "", rotate: "deg" }, function (e, t) {
          var s = ref.image_style[e];
          s && i.push(e + "(" + s + t + ")");
        }),
        i &&
          e.append(
            $('<style id="image-style">').text(
              "img { transform: " + i.join(" ") + "}"
            )
          );
    }),
    (this.import_state_set = function (e) {
      ...
      this.import_dialog &&
        ((this.import_state = e),
        (t = $(this.import_dialog)
          .parent()
          .find(".ui-dialog-buttonset > button")
          .first()),
        "error" != e
          ? (t.hide(), t.next().text(this.gettext("close")).focus())
          : t.prop("disabled", !1));
    }),
    (this.ksearch_keydown = function (e, t, s) {
      ...
      switch (i) {
        ...
        case 40:
          ...
          return (
            (a = a || this.ksearch_pane.__ul.firstChild) &&
              this.ksearch_select(n ? a.previousSibling : a.nextSibling),
            rcube_event.cancel(e)
          );
        case 9:
          if (
            rcube_event.get_modifier(e) == SHIFT_KEY ||
            !this.ksearch_visible()
          )
            return void this.ksearch_hide();
        case 13:
          return this.ksearch_visible()
            ? (this.insert_recipient(this.ksearch_selected),
              this.ksearch_hide(),
              9 == i ? null : rcube_event.cancel(e))
            : !1;
        case 27:
          return void this.ksearch_hide();
        case 37:
    ...
    (this.ksearch_visible = function () {
      return (
        null !== this.ksearch_selected &&
        void 0 !== this.ksearch_selected &&
        this.ksearch_value
      );
    }),
      ...
      this.ksearch_pane &&
        ...
        e &&
          ...
          $(this.ksearch_input).attr(
            ...
            "rcmkSearchItem" + this.ksearch_selected
          ));
    }),
    (this.insert_recipient = function (e) {
      ...
      null !== e &&
        ...
        "object" == typeof s && "group" == s.type && !s.email && s.id
          ? ((i = (e = "​" + s.name + "​") + ", "),
            (this.group2expand[s.id] = { name: e, input: this.ksearch_input }),
            this.http_request(
              "mail/group-expand",
              { _source: s.source, _gid: s.id },
              !1
            ))
          : "object" == typeof s && s.name
          ? ((i = s.name + ", "), (t = !0))
          : "string" == typeof s && ((i = s + ", "), (t = !0)),
    ...
    (this.replace_group_recipients = function (e, t) {
      ...
      s &&
        (this.ksearch_input_replace(s.name, t, s.input),
        this.triggerEvent("autocomplete_insert", {
          field: s.input,
          insert: t,
          data: s,
    ...
    (this.ksearch_query_results = function (e, t, s) {
      if (
        (this.multi_thread_http_response(e, s),
        ...
        var i,
          ...
          l,
          c = this.is_framed(),
          h = this.ksearch_value,
          d = this.env.autocomplete_max || 15;
        if (
          (this.ksearch_pane ||
            ((r = $("<ul>")),
            (this.ksearch_pane = $("<div>")
              ...
              .css({ position: "absolute", "z-index": 3e4 })
              .append(r)
              .appendTo((c ? parent.document : document).body)),
          ...
          this.ksearch_pane.data("reqid", s),
            ...
            (this.env.contacts = []);
          var _ =
              $("html").is(".layout-small,.layout-phone") &&
              1 == $(this.ksearch_input).parents(".ac-input").length,
            u = (
              _
                ? $(this.ksearch_input).parents(".ac-input")
                : $(this.ksearch_input)
            )[0],
            p = $(u).offset();
          if (
          ...
          var m = $(c ? parent : window).width(),
            t = $(u).outerWidth(),
            c = 200 < m - p.left ? p.left : m - 200,
            u = p.top + u.offsetHeight + 1,
            m = Math.min(400, m - c);
        ...
        if (e && (a = e.length))
          for (i = 0; i < a && 0 < d; i++)
            (o = "object" == typeof e[i] ? e[i].display || e[i].name : e[i]),
              ...
              ($("<li>")
                .attr({ id: "rcmkSearchItem" + n, role: "option" })
                .html(
                  '<i class="icon"></i>' +
                    this.quote_html(
                      o.replace(
                        new RegExp("(" + RegExp.escape(h) + ")", "ig"),
                        "##$1%%"
                      )
                    ).replace(/##([^%]+)%%/g, "<b>$1</b>")
                )
    ...
    (this.ksearch_input_replace = function (e, t, s, i) {
      var n, a, r;
      (this.ksearch_input || s) &&
        ((s = s || this.ksearch_input),
    ...
    (this.contactlist_select = function (n) {
      ...
      var e,
        ...
        r = !1,
        i = !1,
        o = n.get_selection().length,
        l = this.env.source ? this.env.address_sources[this.env.source] : null;
      return (
        this.env.contentframe &&
        !n.multi_selecting &&
        (e = n.get_single_selection())
          ? (this.preview_timer = setTimeout(function () {
        ...
        o &&
          ...
          $.each(n.get_selection(), function (e, t) {
            var s,
              i = n.data[t];
            l
              ? ((a = a || (!l.readonly && !i.readonly)),
                (r = r || !0 === l.deletable))
              : (t = (s = String(t).replace(/^[^-]+-/, ""))
                  ? ref.env.address_sources[s]
                  : null) &&
                ((a = a || (!t.readonly && !i.readonly)),
                (r = r || !0 === t.deletable),
    ...
    (this.list_contacts = function (e, t, s, i) {
      var n,
        a = -1,
        r = {},
        o = void 0 === e && void 0 === t && void 0 === s,
        l = window;
      (e = e || this.env.source),
        o && (t = this.env.group),
        e != this.env.source
          ? ((s = this.env.current_page = 1), this.reset_qsearch())
          : o || t == this.env.group || (s = this.env.current_page = 1),
        this.env.search_id
          ? (n = "S" + this.env.search_id)
          : this.env.search_request || (n = t ? "G" + e + t : e),
        (this.env.source = e),
        (this.env.group = t),
        $.each(this.env.address_group_stack, function (e, t) {
          if (ref.env.group == t.id) return (a = e), !1;
        }),
        (this.env.address_group_stack =
          a < 0 ? [] : this.env.address_group_stack.slice(0, a)),
        this.destroy_entity_selector("contactgroup-selector"),
        this.env.group
          ? (((i = i || {}).id = this.env.group),
            this.env.address_group_stack.push(i),
            (n = "G" + e + this.env.address_group_stack[0].id))
          : this.gui_objects.addresslist_title &&
            $(this.gui_objects.addresslist_title).text(
              this.get_label("contacts")
            ),
        this.env.search_id || this.select_folder(n, "", !0),
        this.gui_objects.contactslist
          ? this.list_contacts_remote(e, t, s)
          : ((n = this.get_frame_window(this.env.contentframe)) &&
              ((l = n), (r._framed = 1)),
            t && (r._gid = t),
            s && (r._page = s),
            e && (r._source = e),
    ...
    (this.list_contacts_remote = function (e, t, s) {
      ...
      e && (i._source = e),
        ...
        this.env.search_request && (i._search = this.env.search_request),
        this.http_request(
          "mail" == this.env.task ? "list-contacts" : "list",
          i,
          n
        ),
        "mail" != this.env.task &&
    ...
    (this.set_group_prop = function (e) {
      var t, s;
      this.gui_objects.addresslist_title &&
        ((t = $(this.gui_objects.addresslist_title).html("")),
        (1 < this.env.address_group_stack.length ||
          (1 == this.env.address_group_stack.length &&
            this.env.address_group_stack[0].search_request)) &&
          ((s = $('<a href="#list">...</a>')
    ...
    (this.load_contact = function (e, t, s) {
      var i,
        n = {},
        a = window,
        r = this.contact_list ? this.contact_list.data[e] : null;
      ...
      return (
        !t ||
          (!e && "add" != t) ||
          this.drag_active ||
          (this.env.group && (n._gid = this.env.group),
    ...
    (this.contacts_drag_menu = function (e, t) {
      ...
      if (
        ("" == i &&
          1 == this.env.selection_sources.length &&
          (i = this.env.selection_sources[0]),
        "group" != t.type || s != i)
      )
        return this.commands.move || rcube_event.get_modifier(e) == SHIFT_KEY
          ? this.drag_menu(e, t)
          : (this.copy_contacts(t), !0);
      e = this.contact_list.get_selection().join(",");
      return this.group_member_change("add", e, s, t.id), !0;
    }),
    (this.copy_contacts = function (e, t, s) {
      if (!e)
        return (
          (s = this.contact_list.get_selection()),
          this.addressbook_selector(t, function (e, t) {
            e = $(t).data("source")
              ? ref.env.contactgroups[
                  "G" + $(t).data("source") + $(t).data("gid")
                ]
              : ref.env.address_sources[e];
            ref.copy_contacts(e, null, s);
          })
        );
      var i,
        n,
        a = "group" == e.type ? e.source : e.id,
        r = this.env.source,
        t = this.env.group || "";
      (s = (s || this.contact_list.get_selection()).join(",")) &&
        this.env.address_sources[a] &&
        !this.env.address_sources[a].readonly &&
        ("" == r &&
          1 == this.env.selection_sources.length &&
          (r = this.env.selection_sources[0]),
        "group" == e.type
          ? a != r &&
            ((i = this.display_message("copyingcontact", "loading")),
            (n = {
              _cid: s,
              _source: this.env.source,
              _to: a,
          ...
          : e.id != r &&
            ((i = this.display_message("copyingcontact", "loading")),
            (n = { _cid: s, _source: this.env.source, _to: e.id, _gid: t }),
            this.http_post("copy", n, i)));
    }),
    (this.move_contacts = function (e, t, s) {
      ...
      var i = "group" == e.type ? e.source : e.id,
        t = this.env.source;
      this.env.group;
      this.env.address_sources[i] &&
        !this.env.address_sources[i].readonly &&
        ((s = s || this.contact_list.get_selection()),
        "" == t &&
          1 == this.env.selection_sources.length &&
          (t = this.env.selection_sources[0]),
        "group" == e.type
          ? i != t &&
            this._with_selected_contacts("move", {
              _to: i,
              _togid: e.id,
              _cid: s,
            })
          : e.id != t &&
            this._with_selected_contacts("move", { _to: e.id, _cid: s }));
    }),
    (this.delete_contacts = function () {
      var e;
      this.env.source && this.env.address_sources[this.env.source].undelete
        ? this._with_selected_contacts("delete", {
            _cid: this.contact_list.get_selection(),
          })
        : ((e = this.contact_list.get_selection()),
          this.confirm_dialog(
            this.get_label("deletecontactconfirm"),
            "delete",
            function () {
              ref._with_selected_contacts("delete", { _cid: e });
            }
          ));
    }),
      ...
      if (s.length || this.env.cid) {
        var i,
          ...
          a = this.display_message(
            "delete" == e ? "contactdeleting" : "movingcontact",
            "loading"
          ),
          r = this.check_display_next();
        if (this.env.cid) n.push(this.env.cid);
        else {
    ...
    (this.init_contact_form = function () {
      ...
      $(".contactfieldgroup .row a.deletebutton").click(function () {
        return ref.delete_edit_field(this), !1;
      }),
        ...
        "search" == this.env.action &&
          $(this.gui_objects.editform)
            ...
            .submit(function () {
              return $("input.mainaction").click(), !1;
            });
    }),
    (this.group_create = function () {
      var t = $("<input>").attr({ type: "text", "data-submit": "true" }),
    ...
    (this.group_rename = function () {
      ...
      this.env.group &&
        ((t =
          this.env.contactgroups["G" + this.env.source + this.env.group].name),
        (s = $("<input>").attr({ type: "text", "data-submit": "true" }).val(t)),
        (e = $("<label>").text(this.get_label("namex")).append(s)),
        (i = this.env.source),
        (n = this.env.group),
    ...
    (this.group_delete = function () {
      ...
      this.env.group &&
        ((t = this.env.group),
        this.confirm_dialog(
          this.get_label("deletegroupconfirm"),
          "delete",
          function () {
            var e = ref.set_busy(!0, "groupdeleting");
            ref.http_post(
              "group-delete",
              { _source: ref.env.source, _gid: t },
              e
            );
          }
        ));
    ...
    (this.remove_group_item = function (e) {
      ...
      this.treelist.remove(t) &&
        (this.destroy_entity_selector("addressbook-selector"),
        this.destroy_entity_selector("contactgroup-selector"),
        this.triggerEvent("group_delete", { source: e.source, id: e.id }),
        delete this.env.contactfolders[t],
        delete this.env.contactgroups[t]),
        e.source == this.env.source &&
          e.id == this.env.group &&
          this.list_contacts(e.source, 0);
    }),
    ...
    (this.remove_group_contacts = function (e) {
      if (void 0 !== this.env.group && this.env.group === e.gid) {
        for (
          var t = this.contact_list.get_selection(),
            s = this.check_display_next(),
            i = 0;
          i < t.length;
          i++
        )
          (id = t[i]), this.contact_list.remove_row(id, s && i == t.length - 1);
    ...
    (this.insert_contact_group = function (e) {
      ...
      (this.env.contactfolders[t] = this.env.contactgroups[t] = e),
        this.treelist.insert(
          { id: t, html: s, classes: ["contactgroup"] },
          e.source,
          "contactgroup"
        ),
        this.destroy_entity_selector("addressbook-selector"),
    ...
    (this.update_contact_group = function (e) {
      ...
      e.newid
        ? ((t = "G" + e.source + e.newid),
          ...
          (n.id = t),
          (n.html = $("<a>")
            .attr({ href: "#", rel: e.source + ":" + e.newid })
            .click(function () {
              return ref.command("listgroup", s, this);
            })
            .text(e.name)))
        : ($(this.treelist.get_item(i)).children().first().text(e.name),
          (this.env.contactfolders[i].name = this.env.contactgroups[i].name =
            e.name),
          e.source == this.env.source &&
            e.id == this.env.group &&
            this.set_group_prop(e)),
    ...
    (this.update_group_commands = function () {
      var e =
          "" != this.env.source
            ? this.env.address_sources[this.env.source]
            : null,
      ...
      if (i.length)
        ...
        if (
          (i.length ||
            ...
            (i = $("<fieldset>").addClass(
              "contactfieldgroup contactcontroller" + e
            )),
          ...
          var n,
            a,
            r,
            o = this.env.coltypes[e],
            l = 1 != o.limit ? "[]" : "",
            c = !!$(s).data("compact"),
            t = "ff_" + e + (o.count || 0),
            h = $("<div>").addClass("row input-group"),
            d = $("<div>").addClass("contactfieldcontent " + o.type);
          if (
            (o.subtypes_select
              ? ((n = $(o.subtypes_select)),
                c
                  ? n.addClass("input-group-prepend")
                  : (n = $("<div>")
                      .addClass("contactfieldlabel label")
                      .append(n)))
              : ((n = $("<label>")
                  .addClass("contactfieldlabel label input-group-text")
                  .attr("for", t)
                  .text(o.label)),
            ...
            (a = $("<input>")
              .addClass("form-control ff_" + e)
              .attr({ type: "text", name: "_" + e + l, size: o.size, id: t })),
              this.init_edit_field(e, a),
              "date" == o.type &&
                $.datepicker &&
                a.addClass("datepicker").datepicker();
          else if ("textarea" == o.type)
            (a = $("<textarea>")
              .addClass("form-control ff_" + e)
              .attr({ name: "_" + e + l, cols: o.size, rows: o.rows, id: t })),
              this.init_edit_field(e, a);
            ...
            var _,
              ...
              b = d;
            if (
              (h.addClass("composite"),
              c && (b = $('<div class="content input-group-text">')),
              (f = this.env[e + "_template"]))
            )
              for (_ = 0; _ < f.length; _++) g.push(f[_][1]), v.push(f[_][2]);
            else for (u in o.childs) g.push(u);
            for (_ = 0; _ < g.length; _++)
              (u = g[_]),
                (p = o.childs[u]),
                (a = $("<input>")
                  .addClass("form-control ff_" + u)
                  .attr({ type: "text", name: "_" + u + l, size: p.size })
                  .appendTo(b)),
                c || b.append(v[_] || " "),
            ...
            "select" == o.type &&
              (((r = (a = $("<select>")
                .addClass("custom-select ff_" + e)
                .attr({ name: "_" + e + l, id: t })).attr("options"))[
                r.length
              ] = new Option("---", "")),
              o.options &&
                $.each(o.options, function (e, t) {
                  r[r.length] = new Option(t, e);
                }));
          a &&
            ((t = $('<a href="#del"></a>')
              .addClass(
                "contactfieldbutton deletebutton input-group-text icon delete"
              )
              .attr({ title: this.get_label("delete"), rel: e })
            ...
            c
              ? (h.append(a).append(t),
                t.wrap('<span class="input-group-append">'))
              : ("composite" != o.type && d.append(a), h.append(d.append(t))),
            h.appendTo(i.show()),
    ...
    (this.delete_edit_field = function (e) {
      ...
      --s.count <= 0 && s.visible
        ? i.find("input").val("").blur()
        : (i.remove(), n.children("div.row").length || n.hide()),
        e.length &&
          ((n = e.children('option[value="' + t + '"]')).length
            ? n.prop("disabled", !1)
            : (n = $("<option>").attr("value", t).html(s.label).appendTo(e)),
          e.show());
    }),
    (this.upload_contact_photo = function (e) {
      e &&
        e.elements._photo.value &&
        (this.async_upload_form(e, "upload-photo", function (e) {
    ...
    (this.replace_contact_photo = function (e) {
      var t =
        "-del-" == e
          ? this.env.photo_placeholder
          : this.env.comm_path +
            "&_action=photo&_source=" +
            this.env.source +
            "&_cid=" +
            (this.env.cid || 0) +
            "&_photo=" +
    ...
    (this.photo_upload_end = function () {
      this.set_busy(!1, null, this.file_upload_id), delete this.file_upload_id;
    }),
    (this.set_photo_actions = function (e) {
      for (var t = this.buttons["upload-photo"], s = 0; t && s < t.length; s++)
        $("a#" + t[s].id).html(
          this.get_label("-del-" == e ? "addphoto" : "replacephoto")
        );
      $("#ff_photo").val(e),
        this.enable_command("upload-photo", !!this.env.coltypes.photo),
        this.enable_command(
          "delete-photo",
          this.env.coltypes.photo && "-del-" != e
        );
    }),
    (this.advanced_search = function () {
      var s = $("<iframe>").attr(
        "src",
        this.url("search", { _form: 1, _framed: 1 })
      );
      return (
        this.simple_dialog(
          s,
          this.gettext("advsearch"),
          function () {
            var e = !1,
              t = { _adv: 1 };
            if (
              ($.each(
                $(
                  s[0].contentWindow.rcmail.gui_objects.editform
                ).serializeArray(),
                function () {
                  this.name.match(/^_search/) &&
                    "" != this.value &&
                    ((t[this.name] = this.value), (e = !0));
                }
              ),
              e)
            )
              return (
                ref.http_post("search", t, ref.set_busy(!0, "searching")), !0
              );
          },
          { button: "search", width: 600, height: 500 }
        ),
        !0
      );
    }),
    (this.unselect_directory = function () {
      this.select_folder(""), this.enable_command("search-delete", !1);
    }),
    (this.insert_saved_search = function (e, t) {
      ...
      this.savedsearchlist.insert(
        { id: s, html: i, classes: ["contactsearch"] },
        null,
        "contactsearch"
      ),
      ...
      this.simple_dialog(e, "searchsave", function () {
        ...
        if ((e = t.val()))
          return (
            ref.http_post(
              "search-create",
              { _search: ref.env.search_request, _name: e },
              ref.set_busy(!0, "loading")
            ),
            !0
          );
    ...
    (this.search_delete = function () {
      var e;
      this.env.search_request &&
        ((e = this.set_busy(!0, "savedsearchdeleting")),
        this.http_post("search-delete", { _sid: this.env.search_id }, e));
    }),
    (this.remove_search_item = function (e) {
      this.savedsearchlist.remove("S" + e) &&
        this.triggerEvent("search_delete", { id: e }),
        (this.env.search_id = null),
        (this.env.search_request = null),
        this.list_contacts_clear(),
        this.reset_qsearch(),
    ...
    (this.listsearch = function (e) {
      ...
      this.contact_list && this.list_contacts_clear(),
        ...
        this.savedsearchlist
          ? (this.treelist.select(""), this.savedsearchlist.select("S" + e))
          : this.select_folder("S" + e, "", !0),
        (this.env.current_page = 1),
        this.http_request("search", { _sid: e }, t);
    }),
    (this.qrcode = function () {
      var e = this.get_label("qrcode"),
        t = new Image(300, 300);
      return (
        (t.src = this.url("addressbook/qrcode", {
          _source: this.env.source,
          _cid: this.get_single_cid(),
        })),
        this.simple_dialog(t, e, null, {
          button: !1,
          cancel_button: "close",
          width: 300,
          height: 300,
    ...
    (this.section_select = function (e) {
      ...
      e &&
        (t = this.get_frame_window(this.env.contentframe)) &&
        this.location_href(
          { _action: "edit-prefs", _section: e, _framed: 1 },
          t,
          !0
        );
    }),
    (this.response_select = function (e) {
      ...
      this.enable_command(
        "delete",
        !!e && $.inArray(e, this.env.readonly_responses) < 0
      ),
    ...
    (this.load_response = function (e, t) {
      ...
      (s = this.get_frame_window(this.env.contentframe)) &&
        ((!e && "add-response" != t) ||
          (e || this.responses_list.clear_selection(),
          this.location_href({ _action: t, _key: e, _framed: 1 }, s, !0)));
    }),
    (this.identity_select = function (e) {
      var t = e.get_single_selection();
      this.enable_command(
        "delete",
        !!t && 1 < e.rowcount && this.env.identities_level < 2
      ),
    ...
    (this.load_identity = function (e, t) {
      ...
      (s = this.get_frame_window(this.env.contentframe)) &&
        ((!e && "add-identity" != t) ||
          (e || this.identity_list.clear_selection(),
          this.location_href({ _action: t, _iid: e, _framed: 1 }, s, !0)));
    }),
    (this.delete_identity = function (e) {
      var t = this.identity_list.get_selection();
      (t.length || this.env.iid) &&
        (e = e || this.env.iid || t[0]) &&
        this.confirm_dialog(
          this.get_label("deleteidentityconfirm"),
          "delete",
          function () {
            ref.http_post("settings/delete-identity", { _iid: e }, !0);
          }
        );
    }),
    (this.update_identity_row = function (e, t, s) {
      ...
      s
        ? (i.insert_row({
            id: "rcmrow" + e,
            cols: [{ className: "mail", innerHTML: t }],
          }),
          i.select(e))
        : i.update_row(e, [t]);
    }),
    (this.update_response_row = function (e, t) {
      var s = this.responses_list;
      s && t
        ? s.update_row(t, [e.name], e.key, !0)
        : s &&
          (s.insert_row({
            id: "rcmrow" + e.key,
            cols: [{ className: "name", innerHTML: e.name }],
          }),
          s.select(e.key));
    }),
    (this.remove_response = function (e) {
      this.env.textresponses && delete this.env.textresponses[e],
        this.responses_list &&
          (this.responses_list.remove_row(e), this.show_contentframe(!1)),
        this.enable_command("delete", !1);
    }),
    (this.remove_identity = function (e) {
      var t = this.identity_list,
        s = this.html_identifier(e);
      t && e && (t.remove_row(s), this.show_contentframe(!1)),
        this.enable_command("delete", !1);
    }),
    (this.init_subscription_list = function () {
      var e = RegExp.escape(this.env.delimiter);
      (this.last_sub_rx = RegExp("[" + e + "]?[^" + e + "]+$")),
        (this.subscription_list = new rcube_treelist_widget(
          this.gui_objects.subscriptionlist,
          {
            selectable: !0,
            tabexit: !1,
          ...
          .droppable({
            accept: function (e) {
              ...
              return (
                e &&
                !e[2] &&
                s != t.replace(ref.last_sub_rx, "") &&
                !s.startsWith(t + ref.env.delimiter)
              );
            },
            drop: function (e, t) {
    ...
    (this.subscription_select = function (e) {
      var t;
      e && "*" != e && (t = this.env.subscriptionrows[e])
        ? ((this.env.mailbox = e),
          this.show_folder(e),
          this.enable_command("delete-folder", !t[2]))
    ...
    (this.subscription_move_folder = function (e, t) {
      ...
      e &&
        null !== t &&
        e != t &&
        t != e.replace(this.last_sub_rx, "") &&
        ((s = e.split(this.env.delimiter).pop()),
        (i = "" === t || "*" === t ? s : t + this.env.delimiter + s) != e &&
          this.confirm_dialog(
            ...
            function () {
              ref.http_post(
                "rename-folder",
                { _folder_oldname: e, _folder_newname: i },
    ...
    (this.delete_folder = function (e) {
      (e = e || this.env.mailbox) &&
        this.confirm_dialog(
          this.get_label("deletefolderconfirm"),
          "delete",
          function () {
            ref.http_post(
              "delete-folder",
    ...
    (this.add_folder_row = function (e, t, s, i, n, a, r, o) {
      ...
      this.subscription_list.is_search() &&
        (this.subscription_select(), this.subscription_list.reset_search()),
        this.subscription_list.is_draggable() &&
      ...
      var l,
        ...
        f = [],
        g = [],
        v = $(this.gui_objects.subscriptionlist),
        b = r || $($("li", v).get(1)).clone(!0);
      if (!b.length) return this.goto_url("folders"), !1;
      b.attr({ id: "rcmli" + this.html_identifier_encode(e), class: a }),
        (r && r.length) ||
          ($("ul,div.treetoggle", b).remove(), b.removeData("filtered")),
        $("a", b).first().text(s).removeAttr("title"),
        $('input[name="_subscribed[]"]', b)
          .first()
          .val(e)
          .prop({ checked: !!n, disabled: !!i }),
      ...
      for (l in (m.sort(function (e, t) {
        for (
          var s,
            i,
            n = e[0].split(ref.env.delimiter),
            a = t[0].split(ref.env.delimiter),
            r = n.length,
            o = 0;
          o < r;
          o++
      ...
      m))
        (u = m[l][3]),
          m[l][2]
            ? (h = u + this.env.delimiter) != this.env.prefix_ns &&
              (g.push(u), (c = h))
            : c && u.startsWith(c)
            ? g.push(u)
            : (f.push(u), (c = null));
      ...
      for (l = 0; !d && l < f.length; l++) l && f[l] == e && (d = f[l - 1]);
      if (d && (l = this.subscription_list.get_item(d, !0)))
        if (
          ((s = e.lastIndexOf(this.env.delimiter)) &&
            ((p = e.substring(0, s)),
            (p = this.subscription_list.get_item(p, !0)),
            $("div.treetoggle", p).length ||
              $("<div>&nbsp;</div>")
                .addClass("treetoggle collapsed")
                .appendTo(p),
            $("ul", p).length || $("<ul>").css("display", "none").appendTo(p)),
          p && l == p)
        )
          $("ul", p).first().append(b);
        else {
      ...
      return (
        $.extend(this.env.subscriptionrows, o || {}),
        ...
        r || this.triggerEvent("clonerow", { row: b, id: e }),
        b
      );
    }),
    (this.replace_folder_row = function (e, i, n, t, s, a) {
      if (!this.gui_objects.subscriptionlist)
        return (
          !!this.is_framed() &&
          window.parent.rcmail.replace_folder_row(e, i, n, t, s, a)
        );
      this.subscription_list.is_search() &&
        (this.subscription_select(), this.subscription_list.reset_search());
      var r = {},
      ...
      e != i
        ? ($("li", o).each(function () {
          ...
          l.get(0) == this.gui_objects.subscriptionlist ||
            $("li", l).length ||
            $("ul,div.treetoggle", l.parent()).remove(),
          this.add_folder_row(i, n, t, s, c, a, o, r))
        : $(o).attr("class", a || "");
    }),
    ...
    (this.change_subscription_state = function (e, t) {
      ...
      e &&
        ((i = this.display_message(
          "folder" + (s = t ? "" : "un") + "subscribing",
          "loading"
        )),
        this.http_post(s + "subscribe", { _mbox: e }, i),
        $(this.gui_objects.subscriptionlist)
          .find('input[value="' + e + '"]')
          .prop("checked", t));
    }),
    (this.show_folder = function (e, t, s) {
      ...
      t && (e += "&_path=" + urlencode(t)),
        (t = this.get_frame_window(this.env.contentframe)) &&
          ((i = t), (e += "&_framed=1")),
        0 <= String(i.location.href).indexOf(e) && !s
          ? this.show_contentframe(!0)
          : this.location_href(this.env.comm_path + e, i, !0);
    }),
    ...
    (this.folder_size = function (e) {
      ...
      this.http_post("folder-size", { _mbox: e }, t);
    }),
    ...
    (this.folder_filter = function (s) {
      this.subscription_list.reset_search(),
        this.subscription_list.container.children("li").each(function () {
          ...
          if ("---" != s)
            if (s) {
              if (t !== s) return void $(this).data("filtered", !0).hide();
            } else
    ...
    (this.init_button = function (e, t) {
      ...
      i &&
        ((s = !1),
        "image" == t.type && ((i = i.parentNode), (s = !0)),
        (i._command = e),
        (i._id = t.id),
        t.sel &&
    ...
    (this.set_button = function (e, t) {
      for (
        var s, i, n = this.buttons[e], a = n ? n.length : 0, r = 0;
        r < a;
        r++
      )
        (s = n[r]),
          (i = document.getElementById(s.id)) &&
            s.status !== t &&
            ("image" != s.type || s.status
              ? s.status || (s.pas = String(i.className))
              : ((s.pas = i._original_src || i.src),
                i.runtimeStyle &&
                  i.runtimeStyle.filter &&
                  i.runtimeStyle.filter.match(/src=['"]([^'"]+)['"]/) &&
                  (s.pas = RegExp.$1)),
            (s.status = t),
            "image" == s.type && s[t]
              ? (i.src = s[t])
              : void 0 !== s[t] && (i.className = s[t]),
            "input" == s.type || "button" == s.type
              ? (i.disabled = "pas" == t)
              : $(i).attr({
                  tabindex:
                    "pas" == t || "sel" == t
                      ? "-1"
                      : $(i).attr("data-tabindex") || "0",
    ...
    (this.button_event = function (e, t, s) {
      for (
        var i, n, a = this.buttons[e], r = a ? a.length : 0, o = 0;
        o < r;
        o++
      )
        (i = a[o]).id == t &&
          "act" == i.status &&
          (i[s] &&
            (n = document.getElementById(i.id)) &&
            (n["image" == i.type ? "src" : "className"] = i[s]),
    ...
    (this.display_message = function (e, t, s, i) {
      if (
        (e && e.length && /^[a-z._]+$/.test(e) && (e = this.get_label(e)),
        this.is_framed())
      )
        return parent.rcmail.display_message(e, t, s);
      if (!this.gui_objects.message)
        return "loading" != t && (this.pending_message = [e, t, s, i]), 1;
      t
        ? "loading" == t &&
          ((i = i || "loading"),
          (s = s || 1e3 * this.env.request_timeout),
          (e = e || this.get_label("loading")))
        : (t = "notice"),
      ...
      if (this.messages[i])
        return (
          this.messages[i].obj &&
            $("div.content", this.messages[i].obj).html(e),
          "loading" == t && this.messages[i].labels.push({ id: a, msg: e }),
      ...
      return (
        (this.messages[i] = { obj: r, elements: [a] }),
        "loading" == t
          ? (this.messages[i].labels = [{ id: a, msg: e }])
          : "uploading" != t &&
            r
              .click(function () {
    ...
    (this.hide_message = function (e, t) {
      if (this.is_framed()) return parent.rcmail.hide_message(e, t);
      if (this.gui_objects.message) {
        var s,
          i,
          n,
          ...
          for (s in r)
            for (i in r[s].elements)
              if (r[s] && r[s].elements[i] == e)
                if ((r[s].elements.splice(i, 1), r[s].elements.length)) {
                  if ("loading" == s)
                    for (n in r[s].labels)
                      r[s].labels[n].id == e
                        ? delete r[s].labels[n]
                ...
                } else this.hide_message_object(r[s].obj, t), delete r[s];
      }
    }),
    ...
    (this.clear_messages = function () {
      if (this.is_framed()) return parent.rcmail.clear_messages();
      var e,
        t,
        s = this.messages;
      for (e in s)
        for (t in s[e].elements) s[e].obj && this.hide_message_object(s[e].obj);
      this.messages = {};
    }),
    (this.display_progress = function (e) {
      ...
      e &&
        e.name &&
        ((t = this.messages["progress" + e.name]),
        e.label || (e.label = this.get_label("uploadingmany")),
        t
          ? !e.total || 100 <= e.percent
            ? this.hide_message(t.obj)
            : (e.text && (e.label += " " + e.text), t.obj.text(e.label))
          : (!e.percent || e.percent < 100) &&
            this.display_message(e.label, "uploading", 0, "progress" + e.name));
    }),
    (this.show_popup_dialog = function (e, t, i, n) {
      if (this.is_framed()) return parent.rcmail.show_popup_dialog(e, t, i, n);
      var s = $('<div class="popup">');
      "object" == typeof e
        ? (s.append(e), $(e).is("iframe") && s.addClass("iframe"))
        : s.html(e);
      var a = 0;
      n &&
        n.button_classes &&
      ...
      return (
        ...
        d.find("input[data-submit]").on("keydown", function (e) {
          13 == e.which &&
            d.find(".ui-dialog-buttonpane button.mainaction").click();
        }),
        this.triggerEvent("dialog-open", { obj: s }),
        s
      );
    }),
    ...
    (this.confirm_dialog = function (e, t, s, i) {
      return (
        (i = $.extend(i || {}, { button: t || "continue", noresize: !0 })),
        this.simple_dialog(
          e,
          i.title || "confirmationtitle",
          function (e, t) {
            return s(e, t), !0;
          },
          i
    ...
    (this.set_page_buttons = function () {
      this.enable_command(
        "nextpage",
        "lastpage",
        this.env.pagecount > this.env.current_page
      ),
        this.enable_command(
          "previouspage",
          "firstpage",
    ...
    (this.select_folder = function (e, t, s) {
      this.savedsearchlist && this.savedsearchlist.select(""),
        this.treelist
          ? this.treelist.select(e)
          : this.gui_objects.folderlist &&
            ($("li.selected", this.gui_objects.folderlist).removeClass(
              "selected"
            ),
            $(this.get_folder_li(e, t, s)).addClass("selected"),
            this.triggerEvent("selectfolder", { folder: e, prefix: t }));
    }),
    (this.mark_folder = function (e, t, s, i) {
      $(this.get_folder_li(e, s, i)).addClass(t),
        this.triggerEvent("markfolder", { folder: e, mark: t, status: !0 });
    }),
    (this.unmark_folder = function (e, t, s, i) {
      $(this.get_folder_li(e, s, i)).removeClass(t),
        this.triggerEvent("markfolder", { folder: e, mark: t, status: !1 });
    }),
    (this.get_folder_li = function (e, t, s) {
      if (((t = t || "rcmli"), this.gui_objects.folderlist))
        return (e = this.html_identifier(e, s)), document.getElementById(t + e);
    }),
    (this.set_message_coltypes = function (e, t, s) {
      (this.env.listcols = e), this.msglist_setup(this.env.layout);
      var i,
        n,
        a,
        r,
        ...
        c = this.message_list,
        h = c ? c.thead : null,
        d = this.env.msglist_cols;
      if ((this.env.coltypes || (this.env.coltypes = {}), h)) {
        if (t) {
          for (r in ((h.innerHTML = ""), (l = document.createElement("tr")), d))
            (a = d[r]),
        ...
        for (r = 0, o = d.length; r < o; r++)
          (n = d[c.checkbox_selection ? r - 1 : r]),
            !(i = h.rows[0].cells[r]) ||
              ("from" != n && "to" != n && "fromto" != n) ||
              $(i)
                .attr("rel", n)
                .find("span,a")
                .text(this.get_label("fromto" == n ? s : n));
      }
      (this.env.subject_col = null),
        (this.env.flagged_col = null),
        (this.env.status_col = null),
        this.env.coltypes.folder &&
          (this.env.coltypes.folder.hidden =
            !(this.env.search_request || this.env.search_id) ||
            "base" == this.env.search_scope),
        0 <= (r = $.inArray("subject", d)) &&
          ((this.env.subject_col = r), c && (c.subject_col = r)),
        0 <= (r = $.inArray("flag", d)) && (this.env.flagged_col = r),
        0 <= (r = $.inArray("status", d)) && (this.env.status_col = r),
        c &&
          (c.hide_column(
            "folder",
            (this.env.coltypes.folder && this.env.coltypes.folder.hidden) ||
              $.inArray("folder", d) < 0
          ),
          c.init_header());
    }),
    (this.set_rowcount = function (e, t) {
      if (t && t != this.env.mailbox) return !1;
      $(this.gui_objects.countdisplay).html(e), this.set_page_buttons();
    }),
    (this.set_mailboxname = function (e) {
      this.gui_objects.mailboxname &&
        e &&
        (this.gui_objects.mailboxname.innerHTML = e);
    }),
    ...
    (this.set_unread_count = function (e, t, s, i) {
      ...
      (this.env.unread_counts[e] = t),
        ...
        i
          ? this.mark_folder(e, i, "", !0)
          : t || this.unmark_folder(e, "recent", "", !0),
    ...
    (this.set_unread_count_display = function (e, t) {
      ...
      if ((o = this.get_folder_li(e, "", !0))) {
        if (
          ((n = this.env.unread_counts[e] || 0),
          !(i = (r = $(o).children("a").eq(0)).children("span.unreadcount"))
            .length &&
            n &&
            (i = $("<span>").addClass("unreadcount skip-content").appendTo(r)),
          (s = /\s+\([0-9]+\)$/i),
          (a = 0),
          (r = o.getElementsByTagName("div")[0]) &&
            r.className.match(/collapsed/))
        )
          for (var l in this.env.unread_counts)
            l.startsWith(e + this.env.delimiter) &&
              (a += this.env.unread_counts[l]);
        n && i.length
          ? i.html(this.env.unreadwrap.replace(/%[sd]/, n))
          : i.length && i.remove(),
          (s = new RegExp(
    ...
    (this.set_headers = function (e) {
      this.gui_objects.all_headers_box &&
        e &&
        $(this.gui_objects.all_headers_box).html(e).show();
    }),
    (this.show_headers = function (e, t) {
      this.gui_objects.all_headers_row &&
        this.gui_objects.all_headers_box &&
        this.env.uid &&
        ($(t).removeClass("show-headers").addClass("hide-headers"),
        $(this.gui_objects.all_headers_row).show(),
        (t.onclick = function () {
          ref.command("hide-headers", "", t);
        }),
        this.gui_objects.all_headers_box.innerHTML ||
          this.http_request(
            "headers",
            { _uid: this.env.uid, _mbox: this.env.mailbox },
            this.display_message("", "loading")
          ));
    }),
    (this.hide_headers = function (e, t) {
      this.gui_objects.all_headers_row &&
        this.gui_objects.all_headers_box &&
        ($(t).removeClass("hide-headers").addClass("show-headers"),
      ...
      this.entity_selector(
        ...
        function (e, t) {
          ...
          for (
            ...
            s++, i++;
          return (
            t.css("padding-left", s ? 16 * s + "px" : 0),
    ...
    (this.addressbook_selector = function (e, t) {
      var s = [];
      this.entity_selectors["addressbook-selector"] ||
          ...
          function (e, t) {
            return (
              "group" == e.type
                ...
                : t.addClass("addressbook active").data("id", e.id),
    ...
    (this.entity_selector = function (e, t, s, i, n) {
      ...
      l ||
        ...
        l
          ...
          .show(),
        10 < a.length &&
          l.css("max-height", 10 * $("li", l)[0].offsetHeight + 9),
    ...
    (this.destroy_entity_selector = function (e) {
      $("#" + e).remove(),
        ...
        this.triggerEvent("destroy-entity-selector", { name: e });
    }),
    (this.show_menu = function (e, t, s) {
      var i,
        n,
        a,
        r = "object" == typeof e ? e.menu : e,
        o = $("#" + r),
        l = s && s.target ? $(s.target) : $(o.attr("rel") || "#" + r + "link"),
        c = rcube_event.is_keyboard(s),
        h = o.attr("data-align") || "",
        d = !1;
      if (
        ("A" != l.get(0).tagName &&
          l.closest("a").length &&
          (l = l.closest("a")),
        "string" == typeof e && (e = { menu: r }),
        !(o = !o.length
          ? this.triggerEvent("menu-get", {
              name: r,
              props: e,
              originalEvent: s,
            })
      ...
      if (
        ...
        (t = void 0 === t ? !o.is(":visible") : t) &&
          l.length &&
          ((i = $(window)),
          (n = l.offset()),
          (a = 0 <= h.indexOf("bottom")),
          (d =
            "menuitem" == l.attr("role") ||
            0 < l.closest("[role=menuitem]").length),
          (l.offsetWidth = l.outerWidth()),
          (l.offsetHeight = l.outerHeight()),
          !a && n.top + l.offsetHeight + o.height() > i.height() && (a = !0),
          0 <= h.indexOf("right")
            ? (n.left = n.left + l.outerWidth() - o.width())
            : d &&
              ((n.left = n.left + l.offsetWidth - 5),
              (n.top -= l.offsetHeight)),
          n.left + o.width() > i.width() &&
            (n.left = i.width() - o.width() - 12),
          (n.top = Math.max(0, n.top + (a ? -o.height() : l.offsetHeight))),
          o.css({ left: n.left + "px", top: n.top + "px" })),
        t)
      ) {
        for (var _ = this.menu_stack.length - 1; d && 0 <= _; _--)
          $(l).parents("#" + this.menu_stack[_]).length ||
            "menuitem" == $(s.target).parent().attr("role") ||
            this.hide_menu(this.menu_stack[_], s);
        d && this.menu_stack.length
          ? (o.data("parent", $.last(this.menu_stack)),
            o.css(
              "z-index",
              ($("#" + $.last(this.menu_stack)).css("z-index") || 0) + 1
            ))
          : !d &&
            this.menu_stack.length &&
            this.hide_menu(this.menu_stack[0], s),
          o
            .show()
            .attr("aria-hidden", "false")
            .data("opener", l.attr("aria-expanded", "true").get(0)),
          ...
          this.menu_keyboard_active &&
            ((this.focused_menu = r),
            o
              .find("a,input:not(:disabled)")
              .not("[aria-disabled=true]")
              .first()
              .focus());
      } else this.hide_menu(r, s);
      return t;
    }),
    (this.hide_menu = function (e, t) {
      if (this.menu_stack.length) {
        for (
          var s, i = rcube_event.is_keyboard(t), n = this.menu_stack.length - 1;
          0 <= n;
          n--
        )
          (s = $("#" + this.menu_stack[n])
            ...
            this.triggerEvent("menu-close", {
              ...
              obj: s,
              props: { menu: this.menu_stack[n] },
              originalEvent: t,
            }),
            this.menu_stack[n] == e &&
              ((n = -1),
              s.data("opener") &&
                ($(s.data("opener")).attr("aria-expanded", "false"),
                i && s.data("opener").focus())),
            this.menu_stack.pop();
        this.menu_stack.length && i
          ? ((this.menu_keyboard_active = !0),
            ...
            (s && s.data("opener")) ||
              $("#" + this.focused_menu)
                ...
                .first()
                .focus())
          : ((this.focused_menu = null), (this.menu_keyboard_active = !1));
      } else
        this.triggerEvent("menu-close", {
          name: e,
          props: { menu: e },
    ...
    (this.element_position = function (e, t) {
      var t = $(t),
        ...
        t = c.top,
        c = c.left + i;
      "bottom" == a ? ((t += n), (c -= i)) : (c -= 5),
        r < t + o && (t -= o - n) < 0 && (t = Math.max(0, (r - o) / 2)),
        c + l > s.width() && (c -= l + i),
        e.css({ left: c + "px", top: t + "px" });
    }),
    (this.editor_init = function (e, t) {
      this.editor = new rcube_text_editor(e, t);
    }),
    ...
    (this.format_converter = function (e, t, s) {
      if (
        !e ||
        ("html" == t && !e.replace(/<[^>]+>|&nbsp;|\xC2\xA0|\s/g, "").length) ||
        ("html" != t && !e.replace(/\xC2\xA0|\s/g, "").length)
      )
        return (
          s &&
      ...
      var i =
        this.env.editor_warned || confirm(this.get_label("editorwarning"));
      if (((this.env.editor_warned = !0), !i)) return !1;
      var t =
          "?_task=utils&_action=" + ("html" == t ? "html2text" : "text2html"),
    ...
    (this.url = function (e, t) {
      ...
      var i,
        n = this.env.comm_path,
        a = {};
      for (i in (e &&
        e.match(/([a-z0-9_-]+)\/([a-z0-9-_.]+)/) &&
        ((t._action = RegExp.$2),
        (n = n.replace(/\_task=[a-z0-9_-]+/, "_task=" + RegExp.$1))),
      0 === t._framed &&
        ((n = n.replace("&_framed=1", "")), (t._framed = null)),
      t))
        void 0 !== t[i] && null !== t[i] && (a[i] = t[i]);
      return (
        (a = $.param(a)) && (n += (-1 < n.indexOf("?") ? "&" : "?") + a),
        s && (n += (-1 < n.indexOf("?") ? "&" : "?") + s),
        n
      );
    }),
    (this.redirect = function (e, t) {
      !1 !== t && this.set_busy(!0, "loading"),
        this.is_framed()
          ? ((e = e.replace(/&_framed=1/, "")), parent.rcmail.redirect(e, t))
          : (this.env.extwin &&
              ("string" == typeof e
                ? (e += (e.indexOf("?") < 0 ? "?" : "&") + "_extwin=1")
                : (e._extwin = 1)),
            this.location_href(e, window));
    }),
    (this.goto_url = function (e, t, s, i) {
      t = this.url(e, t);
      i && (t = this.secure_url(t)), this.redirect(t, s);
    }),
    (this.location_href = function (e, t, s) {
      s && this.lock_frame(t),
        "object" == typeof e && (e = this.env.comm_path + "&" + $.param(e)),
        bw.ie && t == window
          ? $("<a>").attr("href", e).appendTo(document.body).get(0).click()
          : (t.location.href = e),
        this.start_keepalive();
    }),
    ...
    (this.http_request = function (i, e, n, t) {
      ...
      if (!1 === s) return e._unlock && this.set_busy(!1, null, e._unlock), !1;
      if (s && s.getResponseHeader) return s;
      void 0 !== s && (e = s)._action && ((i = e._action), delete e._action);
      s = this.url(i);
      return (
        this.start_keepalive(),
        $.ajax({
    ...
    (this.abort_request = function (e) {
      e.request && e.request.abort(), e.lock && this.set_busy(!1, null, e.lock);
    }),
    (this.http_response = function (response) {
      if (response) {
        var i, sid, uid, writable, is_multifolder, list, uid, list, uid;
        if (
          (response.unlock && this.set_busy(!1, null, response.unlock),
          ...
          for (i in response.texts)
            "string" == typeof response.texts[i] &&
              this.add_label(i, response.texts[i]);
        if (
          (response.exec && eval(response.exec),
          response.callbacks && response.callbacks.length)
        )
          for (i = 0; i < response.callbacks.length; i++)
            this.triggerEvent(
              response.callbacks[i][0],
              response.callbacks[i][1]
            );
        switch (response.action) {
          case "mark":
            ("show" != this.env.action && "preview" != this.env.action) ||
              "SEEN" != this.env.last_flag ||
              this.set_unread_message(this.env.uid, this.env.mailbox);
            break;
          case "delete":
            "addressbook" == this.task &&
              ((uid = this.contact_list.get_selection()),
              (writable = !1),
              uid &&
                this.contact_list.rows[uid] &&
                (writable =
                  "" == this.env.source
                    ? ((sid = String(uid).replace(/^[^-]+-/, "")),
                      sid &&
                        this.env.address_sources[sid] &&
                        !this.env.address_sources[sid].readonly)
                    : !this.env.address_sources[this.env.source].readonly),
              this.enable_command("delete", "edit", writable),
              this.enable_command(
                "export",
                this.contact_list && 0 < this.contact_list.rowcount
              ),
              this.enable_command("export-selected", "print", !1));
          case "move":
            "show" == this.env.action
              ? (this.enable_command(this.env.message_commands, !0),
                this.env.list_post || this.enable_command("reply-list", !1))
              : "addressbook" == this.task &&
          ...
          case "list":
            "mail" == this.task
              ? ((is_multifolder = this.is_multifolder_listing()),
                (list = this.message_list),
                ...
                this.enable_command(
                  ...
                  "select-all",
                  "select-none",
                  0 < this.env.messagecount
                ),
                this.enable_command(
                  "expunge",
                  "purge",
                  this.env.exists && !is_multifolder
                ),
                ...
                this.enable_command(
                  ...
                  "expand-unread",
                  "collapse-all",
                  this.env.threading && this.env.messagecount && !is_multifolder
                ),
                list &&
                  (("list" != response.action && "search" != response.action) ||
                    (uid &&
                      ("FIRST" === uid
                        ? (uid = list.get_first_row())
                        : "LAST" === uid
                        ? (uid = list.get_last_row())
                        : list.rows[uid] || (uid += "-" + this.env.mailbox),
                      uid && list.rows[uid] && list.select(uid),
                      delete this.env.list_uid),
                    this.enable_command(
                      "set-listmode",
                      this.env.threads && !is_multifolder
                    ),
                    0 < list.rowcount &&
                      !$(document.activeElement).is("input,textarea") &&
                      list.focus(),
                    list.triggerEvent("select")),
                  "getunread" != response.action &&
                    this.triggerEvent("listupdate", {
                      list: list,
                      folder: this.env.mailbox,
              ...
              : "addressbook" == this.task &&
                ...
                ("list" != response.action && "search" != response.action) ||
                  ...
                  list &&
                    ...
                    ("FIRST" === uid
                      ? (uid = list.get_first_row())
                      : "LAST" === uid && (uid = list.get_last_row()),
                    uid && list.rows[uid] && list.select(uid),
                    delete this.env.list_uid,
                    list.triggerEvent("select")),
                  0 < list.rowcount &&
          ...
          case "search-contacts":
            this.contact_list &&
              (0 < this.contact_list.rowcount && this.contact_list.focus(),
              this.triggerEvent("listupdate", {
                list: this.contact_list,
                rowcount: this.contact_list.rowcount,
              }));
    ...
    (this.http_error = function (e, t, s, i, n) {
      ...
      this.set_busy(!1, null, i),
        ...
        this.unload ||
          ...
          (t = e.getResponseHeader("Location")) &&
            "compose" != this.env.action &&
            this.redirect(t),
          403 != e.status
            ? "keep-alive" == n &&
    ...
    (this.multi_thread_http_request = function (e) {
      ...
      for (
        e.reqid = i,
          ...
          t = 0;
        t < n && void 0 !== (s = e._items.shift());
        t++
      )
        e.running++, e.requests.push(this.multi_thread_send_request(e, s));
      return i;
    }),
    (this.multi_thread_send_request = function (e, t) {
      ...
      if (e.postdata) {
        ...
        (n = e.query.replace("%s", t)), (n += "&_reqid=" + e.reqid);
    ...
    (this.multi_thread_http_response = function (e, t) {
      ...
      !s ||
        ...
        void 0 !== (e = s._items.shift())
          ? (s.running++, s.requests.push(this.multi_thread_send_request(s, e)))
          : 0 == s.running &&
            (s.whendone &&
              "function" == typeof s.whendone &&
              s.whendone(s.result),
    ...
    (this.multi_thread_request_abort = function (e) {
      ...
      if (t) {
        ...
        (t.running = 0), (t.cancelled = !0), this.set_busy(!1, "", t.lock);
      }
    }),
    (this.async_upload_form = function (e, t, s) {
      var i = new Date().getTime(),
        n = "rcmupload" + i;
      return (
        this.dummy_iframe(n).on("load", { ts: i }, s),
        $(e)
          .attr({
            target: n,
            action: this.url(t, {
    ...
    (this.file_dropped = function (e) {
      ...
      var t,
        s = e.target.files || e.dataTransfer.files,
        i = {
      ...
      s && s.length
        ? this.file_upload(s, i, {
            name:
              (this.env.filedrop.fieldname || "_file") +
              (this.env.filedrop.single ? "" : "[]"),
            single: this.env.filedrop.single,
            filter: this.env.filedrop.filter,
            action: ref.env.filedrop.action,
          })
        : (t = e.dataTransfer.getData("roundcube-uri")) &&
          ((s = "upload" + new Date().getTime()),
          (e = $("<span>")
            .text(
              e.dataTransfer.getData("roundcube-name") ||
                this.get_label("attaching")
            )
            .html()),
          (i._uri = t),
          (i._uploadid = s),
    ...
    (this.file_upload = function (e, t, i) {
      if (!window.FormData || !e || !e.length) return !1;
      var s,
        n,
        a,
        r = 0,
        ...
        l = new FormData(),
        c = i.name || "_file[]",
        h = i.single ? 1 : e.length;
      for (
        args = $.extend({ _remote: 1, _from: this.env.action }, t || {}), n = 0;
        o < h && (s = e[n]);
        n++
      )
        (i.filter && !s.type.match(new RegExp(i.filter))) ||
          (l.append(c, s), (r += s.size), (a = s.name), o++);
      if (o) {
        if (
          this.env.max_filesize &&
          this.env.filesizeerror &&
          r > this.env.max_filesize
        )
          return this.display_message(this.env.filesizeerror, "error"), !1;
        if (
          this.env.max_filecount &&
          this.env.filecounterror &&
          o > this.env.max_filecount
        )
          return this.display_message(this.env.filecounterror, "error"), !1;
        ...
        this.add2attachment_list(d, {
          ...
          i.lock ||
          (i.lock = this.file_upload_id = this.set_busy(!0, "uploading")),
          (args._uploadid = d),
          (args._unlock = i.lock),
          (this.uploads[d] = $.ajax({
            type: "POST",
            ...
            success: function (e) {
              delete ref.uploads[d], ref.http_response(e);
            },
            error: function (e, t, s) {
    ...
    (this.file_upload_msg = function (e, t) {
      if (t && e < t) {
        ...
        return (
          1073741824 <= t
            ? ((t =
                parseFloat(t / 1073741824).toFixed(1) +
                " ".this.get_label("GB")),
              (e = parseFloat(e / 1073741824).toFixed(1)))
            : 1048576 <= t
            ? ((t =
                parseFloat(t / 1048576).toFixed(1) +
                " " +
                this.get_label("MB")),
              (e = parseFloat(e / 1048576).toFixed(1)))
            : 1024 <= t
            ? ((t = parseInt(t / 1024) + " " + this.get_label("KB")),
              (e = parseInt(e / 1024)))
            : (t = t + " " + this.get_label("B")),
          i
            .replace("$percent", s + "%")
            .replace("$current", e)
            .replace("$total", t)
    ...
    (this.start_keepalive = function () {
      var e;
      !this.env.session_lifetime ||
        this.env.framed ||
        this.env.extwin ||
        "login" == this.task ||
        "print" == this.env.action ||
        (this._keepalive && clearInterval(this._keepalive),
        (e = 0.5 * Math.min(1800, this.env.session_lifetime) * 1e3),
    ...
    (this.refresh = function () {
      ...
      this.busy
        ...
        : ((e = {}),
          ...
          ((e =
            "mail" == this.task && this.gui_objects.mailboxlist
              ? this.check_recent_params()
              : e)._last = Math.floor(this.env.lastrefresh.getTime() / 1e3)),
          (this.env.lastrefresh = new Date()),
          this.http_post("refresh", e, t));
    }),
    (this.check_recent_params = function () {
      var e = { _mbox: this.env.mailbox };
      return (
        this.gui_objects.mailboxlist && (e._folderlist = 1),
      ...
      try {
        if (i && !i.closed && i !== window) {
          if (
            ...
            for (s in t) if (i.rcmail.env[s] != t[s]) return;
          return i.rcmail;
        }
      } catch (e) {}
    }),
    (this.get_single_uid = function () {
      var e =
        this.env.uid ||
        (this.message_list ? this.message_list.get_single_selection() : null);
      return ref.triggerEvent("get_single_uid", { uid: e }) || e;
    }),
    (this.get_single_cid = function () {
      var e =
        this.env.cid ||
        (this.contact_list ? this.contact_list.get_single_selection() : null);
      return ref.triggerEvent("get_single_cid", { cid: e }) || e;
    }),
    (this.get_message_mailbox = function (e) {
      var t;
      return this.env.messages && e && (t = this.env.messages[e]) && t.mbox
        ? t.mbox
        : /^[0-9]+-(.*)$/.test(e)
        ? RegExp.$1
        : this.env.mailbox;
    ...
    (this.get_input_selection = function (e) {
      ...
      return (
        "number" == typeof e.selectionStart &&
          ...
          ((i = e.value), (t = e.selectionStart), (s = e.selectionEnd)),
        { start: t, end: s, text: i.substr(t, s - t) }
      );
    }),
    (this.lock_form = function (e, t) {
      e &&
        e.elements &&
        (t && (this.disabled_form_elements = []),
        $.each(e.elements, function () {
          "hidden" != this.type &&
            (t && this.disabled
              ? ref.disabled_form_elements.push(this)
              : (t || $.inArray(this, ref.disabled_form_elements) < 0) &&
                (this.disabled = t));
        }));
    }),
      ...
      s && "function" == typeof s.registerProtocolHandler
        ? "function" == typeof s.isProtocolHandlerRegistered
          ? (s = s.isProtocolHandlerRegistered(
              "mailto",
              this.mailto_handler_uri()
            )) && $(t).parent().find(".mailtoprotohandler-status").html(s)
          : $(t).click(function () {
              return ref.register_protocol_handler(e), !1;
            })
        : $(t)
            .addClass("disabled")
            .click(function () {
              return ref.display_message("nosupporterror", "error"), !1;
            });
    }),
    (this.browser_capabilities_check = function () {
      this.env.browser_capabilities || (this.env.browser_capabilities = {}),
        $.each(["pdf", "flash", "tiff", "webp", "pgpmime"], function () {
          void 0 === ref.env.browser_capabilities[this] &&
            (ref.env.browser_capabilities[this] =
              ref[this + "_support_check"]());
        });
    }),
    (this.browser_capabilities = function () {
      if (!this.env.browser_capabilities) return "";
      var e,
        t = [];
    ...
    (this.tiff_support_check = function () {
      return this.image_support_check("tiff"), 0;
    }),
    (this.webp_support_check = function () {
      return this.image_support_check("webp"), 0;
    }),
    ...
    (this.pdf_support_check = function () {
      var e,
        t = navigator.mimeTypes ? navigator.mimeTypes["application/pdf"] : {},
        s = navigator.plugins,
        i = s.length,
        n = /Adobe Reader|PDF|Acrobat/i;
      if (t && t.enabledPlugin) return 1;
      if ("ActiveXObject" in window) {
        try {
          if ((t = new ActiveXObject("AcroPDF.PDF"))) return 1;
        } catch (e) {}
        try {
          if ((t = new ActiveXObject("PDF.PdfCtrl"))) return 1;
        } catch (e) {}
      }
      for (e = 0; e < i; e++)
        if ("string" == typeof (t = s[e])) {
          if (n.test(t)) return 1;
        } else if (t.name && n.test(t.name)) return 1;
      return (
        setTimeout(function () {
          $("<object>")
            .attr({
              ...
              style:
                'position: "absolute"; top: -1000px; height: 1px; width: 1px',
            })
    ...
    (this.assets_path = function (e) {
      return (e =
        this.env.assets_path && !e.startsWith(this.env.assets_path)
          ? this.env.assets_path + e
          : e);
    }),
    ...
    (this.get_local_storage_prefix = function () {
      return (
        this.local_storage_prefix ||
          (this.local_storage_prefix =
            "roundcube." + (this.env.user_id || "anonymous") + "."),
        this.local_storage_prefix
      );
    }),
      ...
      try {
        return (
          localStorage.setItem(
            this.get_local_storage_prefix() + e,
            JSON.stringify(t)
          ),
          !0
        );
    ...
    (this.local_storage_remove_item = function (e) {
      try {
        return localStorage.removeItem(this.get_local_storage_prefix() + e), !0;
      } catch (e) {
        return !1;
      }
    }),
...
(rcube_webmail.long_subject_title = function (e, t, s) {
  e.title ||
    ((s = $(s || e)).width() + 15 * (t || 0) > s.parent().width() &&
      (e.title = rcube_webmail.subject_text(s[0])));
}),
  ...
  (rcube_webmail.subject_text = function (e) {
    e = $(e).clone();
    return (
      e.find(".skip-on-drag,.skip-content,.voice").remove(), e.text().trim()
    );
  }),
  ...
  (rcube_webmail.prototype.removeEventListener =
    rcube_event_engine.prototype.removeEventListener),
  (rcube_webmail.prototype.triggerEvent =
